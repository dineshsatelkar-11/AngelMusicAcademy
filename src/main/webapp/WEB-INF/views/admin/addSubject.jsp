		...
		<%@include file="../comman_files/adminHeaderFile.jsp"%>
			...
			<div id="page-wrapper">
				<div class="inner-content">
					<div class="container">
			            <form:form id="addSubjectForm" cssClass="form-horizontal col-md-8" modelAttribute="subject" method="post" action="saveSubject">
    
		                    <div class="form-group">
		                        <div class="control-label col-xs-3"> <form:label path="subjectName" >Subject Name</form:label> </div>
		                        <div class="col-xs-6">
		                            <form:hidden path="subjectId" value="${subject.subjectId}"/>
		                            <form:input cssClass="form-control" path="subjectName" value="${subject.subjectName}"/>
		                        </div>
		                    </div>
		    				<div class="form-group">
		                        <form:label path="subjectDescription" cssClass="control-label col-xs-3">Subject Description</form:label>
		                        <div class="col-xs-6">
		                            <form:input cssClass="form-control" path="subjectDescription" value="${subject.subjectDescription}"/>
		                        </div>
		                    </div>
