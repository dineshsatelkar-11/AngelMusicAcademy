            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="${contextPath}/adminIndex"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> Purchase <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${contextPath}/addPurchaseOrder">Purchase Order</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Add Details <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
