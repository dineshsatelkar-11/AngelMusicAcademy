			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="${contextPath}/products"><i class="lnr lnr-direction-ltr"></i> <span>Products</span></a></li>
						...
						<li class="menu-list"><a href="#"><i class="fa fa-sign-in"></i> <span>Login</span></a>
						...
						<li><a href="${contextPath}/registerUser"><i class="fa fa-user"></i> <span>Enquiry</span></a></li>
					</ul>
				<!--sidebar nav end-->
			</div>
		</div>
