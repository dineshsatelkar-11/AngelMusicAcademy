            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="${contextPath}/branchReceptionIndex"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a></li>
                  ...
                  <li><a><i class="fa fa-desktop"></i> Product View <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a href="${contextPath}/inquiry"><<i class="fa fa-table"></i> Inquiry <span class="fa fa-chevron-down"></span></a></li>
                  <li><a href="${contextPath}/offlineAdmissions"><<i class="fa fa-table"></i> New Admission <span class="fa fa-chevron-down"></span></a></li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Pay Fee <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
