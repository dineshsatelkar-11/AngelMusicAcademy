 ...
 * @author Admin
 */
@WebServlet(name = "CustomerQuatationServlet1", urlPatterns = {"/CustomerQuatationServlet1"})
public class CustomerQuatationServlet1 extends HttpServlet {
  ...
  String savePath = getServletContext().getRealPath("") + File.separator + UPLOAD_DIRECTORY+ File.separator;
        ...
        if (Branch != null) {
            ...
            CustomerAccount.setEmail(Cust_Email);
CustomerAccountDao.updateCustomerAccount1(CustomerAccount);
            ...
            List<CustomerQuatationDetails> pdList = new ArrayList<CustomerQuatationDetails>();
            List<TempCustomerSell> tempProduct = new CustomerSellDAO().getAllProduct();

            CustomerQuatationDAO csdao = new CustomerQuatationDAO();
            ...
            for (TempCustomerSell p : tempProduct) {
                ...
                CustomerQuatationDetails csd = new CustomerQuatationDetails();
                CustomerQuotDetailsDAO csddao = new CustomerQuotDetailsDAO();
            ...
            cs.setCustomerQuatationDetails(pdList);
...
//                String email = p.getEmail();
                ...
                session.setAttribute("msg", "Product Quatation Create Successfully");
                session.setAttribute("printInvoiceID", "Sell");
                session.setAttribute("Sellid", cs.getId());
                response.sendRedirect("Admin/branchReception/CustomerQuatationReport.jsp?accountid=" + customerAccountid);
            } else {
                int i = 2;
