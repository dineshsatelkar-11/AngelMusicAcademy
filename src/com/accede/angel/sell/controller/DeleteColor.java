...
public class DeleteColor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           c=bd.getelementByID(deletecourse);
           c.setDeletestatus(false);
           Boolean b=bd.updatecolor(c);
             if(b){
...
//                out.println("</script>");
                  session.setAttribute("msg", "Color Deleted Successfully");
                response.sendRedirect("Admin/admin/AddColor.jsp");
                  ...
                  HttpSession session = request.getSession();
                session.setAttribute("i", i);
                  session.setAttribute("msg", "Color Allready Assign to Product .");
                response.sendRedirect("Admin/admin/AddColor.jsp");
        }
        }
    }
