 ...
 */
@Entity
public class CustomerQuatation {
    @Id @GeneratedValue
    private int id;
    ...
    private List<CustomerQuatationDetails> CustomerQuatationDetails;
    ...
    public List<CustomerQuatationDetails> getCustomerQuatationDetails() {
        return CustomerQuatationDetails;
    }

    public void setCustomerQuatationDetails(List<CustomerQuatationDetails> CustomerQuatationDetails) {
        this.CustomerQuatationDetails = CustomerQuatationDetails;
    }
