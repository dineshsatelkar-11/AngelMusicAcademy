 ...
 * @author Accede
 */
@WebServlet(name = "DeleteRepairRequest", urlPatterns = {"/DeleteRepairRequest"})
public class DeleteRepairRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ad.setDuedateSmsstatus(false);
            ad.setDuedateSmsdate(new Date());
            ...
            if (Branch.getAdminOfBranch() == null) {
                if (b) {
                    ...
                    session.setAttribute("msg", "Repairing Request Closed  Successfully");
