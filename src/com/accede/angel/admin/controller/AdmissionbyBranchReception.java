 ...
 * @author accede
 */
@WebServlet(name = "AdmissionbyBranchReception", urlPatterns = {"/AdmissionbyBranchReception"})
public class AdmissionbyBranchReception extends HttpServlet {
...
//                                    a.setDuration(durationid);
                                ...
                                if (item.getFieldName().equals("joindate")) {
                                    ...
                                    try {
                                        Date joindateindate=new SimpleDateFormat("dd/MM/yyyy").parse(joindate);
                                        Date duedate=new Dates().getEndingDate(joindateindate, 30);
                                        a.setJoiningDate(new SimpleDateFormat("dd/MM/yyyy").parse(joindate));
                                        a.setNextPaymentDate(duedate);
                                    } catch (ParseException ex) {
                                        ex.printStackTrace();
                                    }
                                }
...
//                                    a.setCourseid(Courseid);
                                ...
                                if (item.getFieldName().equals("Paymentmode")) {
                                    ...
                                    int pay = Integer.parseInt(Paymentmode);
//                                    a.setPaymentmodecount(pay);
//                                    sa.setPaymentmodecount(pay);
                                }
...
//                        } catch (ParseException ex) {
//                            System.out.println("totalfee-" + DueDate);
//                            ex.printStackTrace();
//                        }
