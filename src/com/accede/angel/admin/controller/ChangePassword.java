...
System.out.println("Branch.getAdminPassword()===="+Branch.getAdminPassword());
                AdminDao ad = new AdminDao();
                if (oldpassword.equals(Branch.getAdminPassword())) {

                    if (Branch.getAdminOfBranch() == null) {
                        Branch.setAdminPassword(newpassword);
                        ...
                        if (!newpassword.equals(Branch.getReceptionPassword())) {
                            Branch.setAdminPassword(newpassword);
                            ad.updateAdminid(Branch);
                            int i = 1;
                            session.setAttribute("i", i);
