 ...
 * @author Accede
 */
@WebServlet(name = "AddEnqury", urlPatterns = {"/AddEnqury"})
public class AddEnqury extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                en.setFollowupDate(new SimpleDateFormat("dd/MM/yyyy").parse(follow));
