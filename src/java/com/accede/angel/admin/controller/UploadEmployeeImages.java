 ...
 * @author Admin
 */
@WebServlet(name = "UploadEmployeeImages", urlPatterns = {"/UploadEmployeeImages"})
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
        maxFileSize = 1024 * 1024 * 10, // 10MB
        maxRequestSize = 1024 * 1024 * 50)
public class UploadEmployeeImages extends HttpServlet {
 private static final String SAVE_DIR = "EmployeeImages";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Employee a = bd.getEmployeeByID(id);
