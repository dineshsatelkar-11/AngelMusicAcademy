 ...
 * @author Accede
 */
@WebServlet(name = "UpdateLessonPdf", urlPatterns = {"/UpdateLessonPdf"})
public class UpdateLessonPdf extends HttpServlet {

       private static final String UPLOAD_DIRECTORY = "LessonPDF";
...
a.setCourse(c);
           ...
           LessonPdf ll=new LessonPdf();
           ll=ld.getLessonPdfByID(p6);
           a.setLessonno(ll.getLessonno());

                boolean b = ld.saveLessonPdf1(a);
                ...
                if (b) {
                    ...
                    session.setAttribute("msg", "PDF Update Successfully");

                    response.sendRedirect("Admin/admin/UpdatePdf.jsp");
