 ...
 * @author Accede
 */
@WebServlet(name = "AddLessonPDF", urlPatterns = {"/AddLessonPDF"})
public class AddLessonPDF extends HttpServlet {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                if (b) {
                    ...
                    response.sendRedirect("Admin/admin/AddPDFbyLesson.jsp");
                    ...
                    session.setAttribute("i", i);
                    session.setAttribute("msg", "PDF Already Existed..");
                    response.sendRedirect("Admin/admin/AddPDFbyLesson.jsp");
                }
