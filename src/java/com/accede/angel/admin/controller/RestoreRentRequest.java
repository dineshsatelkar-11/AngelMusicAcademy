 ...
 * @author Accede
 */
@WebServlet(name = "RestoreRentRequest", urlPatterns = {"/RestoreRentRequest"})
public class RestoreRentRequest extends HttpServlet {
 ...
 HttpSession session1 = request.getSession();
            ...
            if (b) {
                ...
                session.setAttribute("msg", "Rent Request Restored  Succefully");
//                out.println("<script type=\"text/javascript\">");
//                out.println("alert('Subject Added successfully');");
//                out.println("location='Admin/admin/addSubject.jsp';");
//                out.println("</script>");
                response.sendRedirect("Admin/admin/CloseRentRequest.jsp");
            } else {
                int i = 2;
                HttpSession session = request.getSession();
                session.setAttribute("i", i);
...
//                out.println("location='Admin/admin/addSubject.jsp';");
//                out.println("</script>");
                response.sendRedirect("Admin/branchReception/CloseRentRequest.jsp");
            } else {
                int i = 2;
                HttpSession session = request.getSession();
                session.setAttribute("i", i);
