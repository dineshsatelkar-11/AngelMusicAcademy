 ...
 * @author Admin
 */
@WebServlet(name = "EditInstrumentRepair", urlPatterns = {"/EditInstrumentRepair"})
public class EditInstrumentRepair extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter())  {
            ...
            if (instrument.getInstrumentName().equals(Instrument)) {
                ...
                instrument.setInstrumentRepairCost(modal_prd_rent);
                ...
                InstrumentRepair instrument1 = new InstrumentRepair();
