...
/**
 *
 * @author Soft Solutions
 */
@WebServlet(name = "AddSms", urlPatterns = {"/AddSms"})
public class AddSms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            smsModel.setAdminOfBranch(Branch);
            SmsDao smsDao = new SmsDao();
          boolean d=  smsDao.saveSms(smsModel);
                if(d){
...
//                out.println("</script>");
                  session.setAttribute("msg", "SMS  Added Successfully");
                response.sendRedirect("Admin/branchReception/AddSms.jsp");
                  ...
                  HttpSession session = request.getSession();
                session.setAttribute("i", i);
                  session.setAttribute("msg", "SMS  Allready Added ");
                response.sendRedirect("Admin/branchReception/AddSms.jsp");
        }
        }
    }
