 ...
 * @author Admin
 */
@WebServlet(name = "UpdateProfileByCamera", urlPatterns = {"/UpdateProfileByCamera"})
public class UpdateProfileByCamera extends HttpServlet {
 private static final String UPLOAD_DIRECTORY = "TempImages";
   private static final String UPLOAD_DIRECTORY1 = "StudentImages";
    /**
...
//        String imagepath = "E:\\Dinesh_update-28_07\\AngelMusicAcademy\\build\\web\\StudentImages\\" + no + "image.png";
       ...
       new CustomerAccountDao().updateCustomerAccount(CustomerAccount);
                    ...
                    response.sendRedirect("Admin/branchReception/StudentProfileDetails.jsp?accountid=" + CustomerAccount.getId());
                    ...
                    response.sendRedirect("Admin/branchReception/StudentProfileDetails.jsp?accountid=" + a.getCustomerAccount().getId());
