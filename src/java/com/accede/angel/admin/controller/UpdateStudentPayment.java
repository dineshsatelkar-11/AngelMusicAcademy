...
// * @author Accede
// */
//@WebServlet(name = "UpdateStudentPayment", urlPatterns = {"/UpdateStudentPayment"})
//public class UpdateStudentPayment extends HttpServlet {
//
//    /**
...
//            account.add(acc);
//            acc.setAmountinWord(amountinword);
//            ad.setRemaininFee(remaining_amount);
//            try {
...
//            long printInvoiceID = add.getLastStudentAccountID();
//
