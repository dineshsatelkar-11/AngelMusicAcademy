 ...
 * @author Accede
 */
@WebServlet(name = "DeleteBatchTime", urlPatterns = {"/DeleteBatchTime"})
public class DeleteBatchTime extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           int batchTimeId=Integer.parseInt(request.getParameter("deletebatch"));
...
//                out.println("</script>");
                  session.setAttribute("msg", "Batch Time Deleted Succefully");
                response.sendRedirect("Admin/branchReception/addBatchTiming.jsp");
                  ...
                  HttpSession session = request.getSession();
                session.setAttribute("i", i);
                  session.setAttribute("msg", "Batch Time Allready Assign to Student .");
                response.sendRedirect("Admin/branchReception/addBatchTiming.jsp");
        }
