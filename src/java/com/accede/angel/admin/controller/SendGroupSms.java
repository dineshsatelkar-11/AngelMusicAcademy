 ...
 * @author Accede
 */
@WebServlet(name = "SendGroupSms", urlPatterns = {"/SendGroupSms"})
public class SendGroupSms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (Branch != null) {
                ...
                cl = CustomerAccountDao.getCustomerAccount(Branch);
                if (cl != null && cl.size() > 0) {
                    for (CustomerAccount p : cl) {
                        
                         SendMessage.sendMobileMSG(p.getMobileNo(), SmsModel.getSms(),Branch);
                    }
                }
...
//                out.println("</script>");
                ...
                response.sendRedirect("Admin/branchReception/GroupSMS.jsp");
