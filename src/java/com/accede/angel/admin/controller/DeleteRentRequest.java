 ...
 * @author Accede
 */
@WebServlet(name = "DeleteRentRequest", urlPatterns = {"/DeleteRentRequest"})
public class DeleteRentRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ad.setCloseRequest(false);
            ad.setRequestClosedDate(new Date());
            ...
            if (Branch.getAdminOfBranch() == null) {
                if (b) {
                    ...
                    session.setAttribute("msg", "Rent Request Closed  Successfully");
