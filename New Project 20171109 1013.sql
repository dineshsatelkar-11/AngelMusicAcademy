...
INSERT INTO `angel`.`barcode` (`id`,`Barcode`,`BarcodePath`,`imagename`) VALUES 
 ...
 (4,'646165416','E:\\teju\\blessings- aquarium\\build\\web\\Barcode\\gfjfgj.png','gfjfgj.png');
...
INSERT INTO `angel`.`productmodel` (`id`,`Cgst`,`Discountper`,`Discription`,`Hsn`,`Igst`,`PurchasePrice`,`Sgst`,`Status`,`UnitPrice`,`productBarcode`,`productname`,`productquantity`,`barcode_id`,`branch_branchId`) VALUES 
 ...
 (2,14.5,0,'kljjknfjkbbfdjhggjhb','131',14,120,10,1,150,'825586387','dfsgg',20,3,NULL),
 (3,14,0,'gsdvfbvdvsghfvvghv','fgjh',28,100,14,0,150,'646165416','gfjfgj',100,4,NULL);
...
--
-- Definition of table `angel`.`purchasetemp`
--

DROP TABLE IF EXISTS `angel`.`purchasetemp`;
CREATE TABLE  `angel`.`purchasetemp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `angel`.`purchasetemp`
--

/*!40000 ALTER TABLE `purchasetemp` DISABLE KEYS */;
INSERT INTO `angel`.`purchasetemp` (`id`,`FinalAmount`,`Hsn`,`PurchasePrice`,`Quantity`,`Total`,`barcode`,`cgstamount`,`cgstper`,`igstamount`,`igstper`,`productName`,`product_id`,`sgstamount`,`sgstper`,`taxableAmount`) VALUES 
 (3,166.2,'131',120,1,120,'825586387',17.4,14.5,16.8,14,'dfsgg',2,12,10,46.2);
...
INSERT INTO `angel`.`tempsaleforbranch` (`id`,`productid`,`productname`,`productquantity`,`productBarcode`) VALUES 
 (1,1,'Guitar',5,'937574904');
...
INSERT INTO `angel`.`venderregistration` (`Id`,`Address`,`BalanceAmount`,`Email`,`Status`,`city`,`companyPhone`,`contactPersonMob`,`contactPersonName`,`dist`,`gstnnumber`,`pin`,`state`,`vendorname`) VALUES 
 (1,'fghfgh',2600,'D@ghvdshg.jhbsdf',0,'fghfgh','613516','vghvghvh','vghvghvhgsdv','fghfgh','dfghfgh','411014','fghdfh','Dinesdvh'),
 (2,'ggjhgbjhghq',0,'vfgjfy@fvj.tfgh',1,'guyguyg','44114313','4646464464','cvghc','bvjbvgjh','ghjbgjhbjhbjvfjhgbvj','411014','bvjhbvjhv','ghfgtd');
/*!40000 ALTER TABLE `venderregistration` ENABLE KEYS */;


--
-- Definition of table `angel`.`vendortransaction`
--

DROP TABLE IF EXISTS `angel`.`vendortransaction`;
CREATE TABLE  `angel`.`vendortransaction` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `angel`.`vendortransaction`
--

/*!40000 ALTER TABLE `vendortransaction` DISABLE KEYS */;
INSERT INTO `angel`.`vendortransaction` (`id`,`Reason`,`TransactionAmount`,`TransactionType`,`Transaction_Date`,`Vendor_Id`,`vendorid_Id`) VALUES 
 (1,'Purchase order against=:gfh',200,'Debit','2017-11-08',1,1);
