...
INSERT INTO `angelmusicacademy`.`event` (`eventId`,`eventAgeCategory`,`eventCreatedDate`,`eventDate`,`eventImgName`,`eventName`,`eventRules`,`eventVenue`) VALUES 
 (2,'PETITE - (4-7),JUNIOR - (8-11),TEEN - (12-14),SENIOR - (15-18),ADULT - (19-25)','2017-05-17 16:54:17','2017-01-01 19:00:00','Koala.jpg','Music Concert','No rules','Pune');
...
INSERT INTO `angelmusicacademy`.`exam` (`examId`,`examDate`,`examName`) VALUES 
 (3,'2017-01-01 16:55:00','Guitar Juniors');
...
INSERT INTO `angelmusicacademy`.`instrument` (`instrumentId`,`instrumentAddedDate`,`instrumentDescription`,`instrumentImgName`,`instrumentName`) VALUES 
 (6,'2017-05-17 16:56:45','auto','Hydrangeas.jpg','VIOLIN');
...
INSERT INTO `angelmusicacademy`.`photosvideos` (`galleryId`,`fileName`,`insertedDate`,`name`,`type`) VALUES 
 (4,'Penguins.jpg','2017-05-17 16:58:44','roveena','image/jpeg'),
 (5,'Tom and Jerry - Funny Little Monster.mp4','2017-05-17 16:59:12','roveena','video/mp4');
...
INSERT INTO `angelmusicacademy`.`user` (`userId`,`userAddress`,`userAge`,`userAttendingDays`,`userAttendingTime`,`userBranch`,`userDOB`,`userEmail`,`userMobileNo`,`userName`,`userPassword`,`userSubject`,`userRegisteredDate`,`balance`,`firstInstallment`,`firstInstallmentDate`,`jrno`,`lastInstallment`,`lastInstallmentDate`,`secondInstallment`,`secondInstallmentDate`,`status`,`totalFees`,`userBranch_branchId`,`AdmissionMode`) VALUES 
 (8,'Kharadi',24,'Monday,Wednesday,Thursday,Saturday','5 T0 6 PM',NULL,'1992-11-11','dinesh@gmail.com','8956276855','DINESH','dinesh','GUITAR','2017-05-17 15:08:30',5000,5000,'2017-05-17','AMA-635993',0,NULL,5000,'2017-07-08','ACTIVE',10000,5,NULL),
 (9,'pune',2,'Monday','10 T0 11 AM',NULL,'2017-05-18','r@gmail.com','9096188458','ROVEENA','123','GUITAR','2017-05-18 14:28:51',0,0,NULL,NULL,0,NULL,0,NULL,'WATING',0,5,NULL),
 (10,'pune',25,'Monday,Tuesday,Wednesday','10 T0 11 AM',NULL,'2017-05-18','abc@gmail.com','9096188458','ABC','123','KEYBORD','2017-05-18 14:56:01',0,0,NULL,NULL,0,NULL,0,NULL,'WATING',0,5,NULL),
 (11,'pune',0,'Tuesday','10 T0 11 AM',NULL,'2017-05-18','aa@gmail.com','9096188458','AA','123','GUITAR','2017-05-18 15:02:28',0,0,NULL,NULL,0,NULL,0,NULL,'WATING',0,5,'ONLINE');
INSERT INTO `angelmusicacademy`.`user` (`userId`,`userAddress`,`userAge`,`userAttendingDays`,`userAttendingTime`,`userBranch`,`userDOB`,`userEmail`,`userMobileNo`,`userName`,`userPassword`,`userSubject`,`userRegisteredDate`,`balance`,`firstInstallment`,`firstInstallmentDate`,`jrno`,`lastInstallment`,`lastInstallmentDate`,`secondInstallment`,`secondInstallmentDate`,`status`,`totalFees`,`userBranch_branchId`,`AdmissionMode`) VALUES 
 (12,'pune',0,'Monday','10 T0 11 AM',NULL,'2017-05-18','r@gmail.com','9096188458','R','123','KEYBORD','2017-05-18 15:48:51',0,0,NULL,NULL,0,NULL,0,NULL,'WATING',0,5,'OFFLINE');
