                ...
                <div class="col-xs-12 pull-left">
                    <div class="panel panel-default height">
                        ...
                        <div class="panel-body">
                        	<div class="col-xs-6">
	                            <strong>Exam No. :</strong> ${examApplication.examno}<br><br>
	                            ...
	                            <strong>Exam  :</strong> ${examApplication.exam.examName}<br><br>
	                            <strong>Exam Date :</strong> ${examApplication.exam.examDate}<br><br>
