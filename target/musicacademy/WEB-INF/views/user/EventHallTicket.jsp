            ...
            <div class="row">
                <div class="col-xs-12 pull-left">
                    <div class="panel panel-default height">
                        <div class="panel-heading"><strong>Hall Ticket</strong><div class="pull-right"></div></div>
                        <div class="panel-body">
                        	<div class="col-xs-6">
	                            <strong>Event Hall Ticket No. :</strong> ${eventApplication.eventNo}<br><br>
	                            ...
	                            <strong>Event Name  :</strong> ${eventApplication.event.examName}<br><br>
	                            <strong>Event Date :</strong> ${eventApplication.event.eventDate}<br><br>
	                            <strong>eventVenue :</strong> ${eventApplication.event.eventVenue}
	                           
                            </div>
                            <div class="col-xs-4">
                                <img src="../gallery/a2.jpg"/><br><br>
			                     <strong>Age Category :</strong> ${eventApplication.event.eventVenue}<br><br>
	                            <strong>Performance Form :</strong> ${eventApplication.event.applicantPerformanceForm}<br><br>
	                            <strong>Teacher Name :</strong> ${eventApplication.event.applicantMusicTeacherName}
                            </div>
