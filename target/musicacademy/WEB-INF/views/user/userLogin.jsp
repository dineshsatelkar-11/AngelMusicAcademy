		...
		<%@include file="../comman_files/nullSessionHeaderFile.jsp"%>
			...
			<div id="page-wrapper">
				<div class="inner-content">
					<div class="container">
			            <form:form id="userLoginForm" cssClass="form-horizontal" modelAttribute="user" method="post" action="authonticateUser">
		                    ...
		                    <div class="form-group">
		                        <div class="control-label col-xs-3"> <form:label path="userEmail" >Email</form:label> </div>
		                        <div class="col-xs-6">
		                            <form:input cssClass="form-control" path="userEmail" value="${user.userEmail }"/>
		                        </div>
		                    </div>
		    				<div class="form-group">
		                        <form:label path="userPassword" cssClass="control-label col-xs-3">Password</form:label>
		                        <div class="col-xs-6">
		                            <form:password cssClass="form-control" path="userPassword" value="${user.userPassword}"/>
		                        </div>
		                    </div>
