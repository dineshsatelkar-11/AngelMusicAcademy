                                                ...
                                                <div id="step-1">
                                                    ...
                                                    <div id="output">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                                <input type="text" class="form-control priceup row0" value="Admission Fee-100"  id="adfee" name="adfee" placeholder="Enter Fee" required>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                                ...
                                                                <input type="date" id="datetimepicker2" name="joindate"  placeholder="Joining Date" class="form-control">
                                                            </div>
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
