       ...
       <div class="modal fade" id="CustomeDate" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal form-label-left input_mask" method="post"  action="Report.jsp"  data-parsley-vdalidate>
                                    ...
                                    <div class="x_title">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                            <div class="form-group">
                                                ...
                                                <button onclick='window.top.location.href = "Report.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                                <button onclick='window.top.location.href = "Report.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                                <button onclick='window.top.location.href = "Report.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                                <!--                                                </div>
                                                                                                <div class="btn btn-default">-->
                                                <button onclick='window.top.location.href = "Report.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                                <button onclick='window.top.location.href = "Report.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                                <button onclick='window.top.location.href = "Report.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                                <!--                                                </div>
                                                                                                <div class="btn btn-default">-->
                                           ...
                                           <table id="datatable-buttons" class="table table-striped table-bordered tablefetch">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        SaveBranchSaleDAO cd = new SaveBranchSaleDAO();
                                                        ...
                                                        if (Days != null) {
                                                            if (Days.equals("-1")) {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    ...
                                                                    cl = cd.getBranchSaleThisMonth(adminfilter);
                                                                } else {
                                                                    cl = cd.getBranchSaleThisMonth();
                                                                }
                                                            } else if (Days.equals("-2")) {

                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getBranchSaleLastMonth(adminfilter);

                                                                } else {
                                                                    cl = cd.getBranchSaleLastMonth();
                                                                }

                                                            } else {
                                                                noofdays = Integer.parseInt(Days);
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getBranchSaleInoutt(adminfilter, noofdays);

                                                                } else {
                                                                    cl = cd.getBranchSaleInoutt(noofdays);
                                                            ...
                                                            if (FDate != null) {
                                                                if (FDate != "") {
                                                                    ...
                                                                    if (adminfilter.getAdminId() != 0) {
                                                                        cl = cd.getBranchSaleInoutt(adminfilter, FromDate, ToDate);

                                                                    } else {
                                                                        cl = cd.getBranchSaleInoutt(FromDate, ToDate);
                                                                    }

                                                                }
                                                            } else {
                                                                cl = cd.getAllBrachSale(adminfilter);
                                                            }
