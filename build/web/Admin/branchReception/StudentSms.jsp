                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <br />
                                        <form action="../../SendGroupSms" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        cl = AdmissionDao.getStudentListRegular(admin);
         ...
         <script type="text/javascript">
            $('#document').ready(function() {
                ...
                $('.sumittt').click(function() {
                    ...
                    $.get("AjaxPages/StudentSmsBulk.jsp", {sms:sms}, function(data) {
