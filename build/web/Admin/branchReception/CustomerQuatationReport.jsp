...
<html lang="en">
   ...
   //                String repairid1 = (String) session.getAttribute("repairid");
    ...
    %>
    <script>
        window.open("QuatProductInvoice.jsp?sellid=<%=sellid%>");</script>
        <%
                }
            }
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_title">
                                        ...
                                        <label class="col-md-offset-6" id="position"><a href="CustomerQuatation.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs"> New Request </a></label>
                                        <div class="clearfix"></div>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        CustomerQuatationDAO b1 = new CustomerQuatationDAO();
                                                        List<CustomerQuatation> AllBrand1 = b1.getAllCustomerQuatation(CustomerAccount);
                                                        int i = 0;
                                                        for (CustomerQuatation c1 : AllBrand1) {
                                                            String date3 = DATE_FORMAT.format(c1.getDate());
                                                            i++;
                                                    %>
                                                    <tr>
                                                        <td><%=i%></td>
...
<!--                                                        <td><%=c1.getCustomername()%></td>
                                                        ...
                                                        <td><%=c1.getDiscount_Per()%></td>
                                                        <td><%=c1.getDiscount_amount()%></td>
                                                        <td><%=c1.getGrandtotal() - c1.getDiscount_amount() - c1.getOther_charges()%></td>
                                                        <td><a href="ViewDetailsforCustomerQuatationReport.jsp?purchaseid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>View Details</i></a></td>
                                                        <td><a href="QuatProductInvoice.jsp?sellid=<%=c1.getId()%>" target="blank" class="btn9 btn btn-success"><i>Print Invoice</i></a></td>
                                                        <td>
                                                            <form class="form-horizontal form-label-left"  action="../../SendQuatation" method="get">
                                                                <input type="hidden" value="<%=c1.getId()%>" id="quatationid" name="quatationid">
                                                                <input type="submit" class="btn9 btn btn-success" value="Send Mail"> 
                                                            </form></td>
                                                    </tr> 
                                                    <%
                                                        }
