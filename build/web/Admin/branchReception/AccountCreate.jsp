    ...
    <body class="nav-md">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="../../CreateAccount" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
       <%                                          if (session.getAttribute("i") != null) {
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" maxlength="10" name="mobile" id="last-name" name="last-name" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
