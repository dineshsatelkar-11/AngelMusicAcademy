...
<!--                                        <label class="col-md-offset-3" id="position"></label>
                                        <label class="col-md-offset-6" id="position"><a href="CustomerSale.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs"> New Request </a><a href="CustomerSale.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs">Exchange</a></label>
                                                                       -->
                                      <div class="clearfix"></div>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<CustomerSale> AllBrand1 = b1.getAllCustomerSale(CustomerAccount);
                                                        
                                                        int i = 0;
                                                        for (CustomerSale c1 : AllBrand1) {
                                                            List<CustomerSaleDetails> AllProduct = c1.getCustomerSaleDetails();
                                                            
                                                            for (CustomerSaleDetails c2 : AllProduct){
String date3 = DATE_FORMAT.format(c1.getDate());
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table_center">
                                                            ...
                                                            %></td> 
                                                        <td><label> <a href="ExchangeForm.jsp?accountid=<%=id%>&saledetailsid=<%=c2.getId()%>&custsaleid=<%=c1.getId()%>" class="btn btn-round btn-info btn-xs">Exchange</a></label></td>
                                                        <td><%=date3%></td>

                                                        <td><%=c2.getProduct().getCategory().getCategory() %></td>
            <td><%=c2.getProduct().getModel().getModelName() %></td>
            <td><%=c2.getProduct().getBrand().getBrand() %></td>
            <td><%=c2.getProduct().getColorModel().getColorName()  %></td>
           
            <td><%=c2.getProductquantity()%></td>
            <td><%=c2.getMrpprice()%></td>
           
            <td><%=c2.getGross_amount()%></td>
