                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <label class="col-md-offset-4" id="position">  <h1>Name:<%=p.getFirstName()%>&nbsp;<%=p.getLastName()%> </h1>   </label>
                                    <div class="clearfix"></div>
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Upload Video</th>
                                                    <th class="table_center">Upload PDF</th>
                                            ...
                                            <form class="form-horizontal form-label-left"  action="../../ConvertStudent" method="get">
                                                <input type="hidden" value="<%=p.getAdmissionId()%>" id="studentidd" name="studentidd">
                                                <td class="table_center"><input type="submit" class="btn btn-round btn-success btn-xs" value="Shift To Old Student"></td>
                                            </form>
                                            ...
                                            <td class="table_center"><a href="UploadVideo.jsp?asd=<%=p.getAdmissionId()%>" class="btn btn-round btn-success btn-xs">Upload Video </a></td>
                                            <td class="table_center"><a href="UploadPdfStudentWise.jsp?asd=<%=p.getAdmissionId()%>" class="btn btn-round btn-success btn-xs">Upload PDF </a></td>
