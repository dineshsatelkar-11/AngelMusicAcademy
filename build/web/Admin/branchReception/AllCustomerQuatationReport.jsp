   ...
   <div class="modal fade" id="CustomeDate" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal form-label-left input_mask" method="post"  action="AllCustomerQuatationReport.jsp"  data-parsley-vdalidate>
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" >
                                <div class="x_panel">
                                    <div class="x_title">
                                      <h2>Customer Quatation Report <small>Client</small></h2>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                            ...
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                            <button onclick='window.top.location.href = "AllCustomerQuatationReport.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                        ...
                                        <div id="Report_Fetch">
                                         <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <%
                                                    CustomerQuatation p = new CustomerQuatation();
                                                    CustomerQuatationDAO cd = new CustomerQuatationDAO();
                                                    ...
                                                    List<CustomerQuatation> cl = null;
                                                    ...
                                                    if (Days != null) {
                                                        if (Days.equals("-1")) {
                                                            ...
                                                            if (adminfilter.getAdminId() != 0) {
                                                                ...
                                                                cl = cd.getCustomerQuatationThisMonth(adminfilter);
                                                            } else {
                                                                cl = cd.getCustomerQuatationThisMonth();
                                                            }
                                                        } else if (Days.equals("-2")) {

                                                            if (adminfilter.getAdminId() != 0) {
                                                                cl = cd.getCustomerQuatationLastMonth(adminfilter);

                                                            } else {
                                                                cl = cd.getCustomerQuatationLastMonth();
                                                            }

                                                        } else {
                                                            noofdays = Integer.parseInt(Days);
                                                            if (adminfilter.getAdminId() != 0) {
                                                                cl = cd.getCustomerQuatationInoutt(adminfilter, noofdays);

                                                            } else {
                                                                cl = cd.getCustomerQuatationInoutt(noofdays);
                                                        ...
                                                        if (FDate != null) {
                                                            if (FDate != "") {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getCustomerQuatationInoutt(adminfilter, FromDate, ToDate);

                                                                } else {
                                                                    cl = cd.getCustomerQuatationInoutt(FromDate, ToDate);
                                                                }

                                                            }
                                                        } else {
                                                            cl = cd.getAllCustomerQuatation(adminfilter);
                                                        }
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="ViewDetailsforCustomerQuatationReport.jsp?purchaseid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>View Details</i></a></td>

                                                </tr> 
                                                <%

                                                            grandtotal = grandtotal + c1.getGrandtotal();
                                                            other_charges = other_charges + c1.getOther_charges();
                                                            discount_amount = discount_amount + c1.getDiscount_amount();
                                                            grosstotal = grosstotal + c1.getGrandtotal() - c1.getOther_charges() - c1.getDiscount_amount();
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="table_center"><%=grandtotal%></th>
                                                    <th class="table_center"><%=other_charges%></th>
                                                    <th class="table_center"><%=discount_amount%></th>
                                                    <th class="table_center"><%=grosstotal%></th>
