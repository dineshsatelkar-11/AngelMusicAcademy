...
<html lang="en">
    ...
    <%     if (session.getAttribute("printInvoiceID") != null) {
            ...
            if (invoicefor.equals("Repair")) {
               
                  long repairid = (Long) session.getAttribute("repairid");
...
//                long repairid = Long.parseLong(repairid1);
                ...
                session.removeAttribute("repairid");
    %>
    <script>
        window.open("Final_Reapairing.jsp?repairing_id=<%=repairid%>");</script>
        <%
                }
            }
