...
<div class='container' >
  <div class="container">
                ...
                <form action="<%= action1%>" method="post" name="payuForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="amount-placeholder">
                            Rs<span  id="aamount"></span>
                            <div id="amount1">
                                <span></span>

                                <input id="amount" name="amount" value=""  class="null card-image form-control" type="hidden"></input>
                            </div></div>
                    </div>
                    ...
                    <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit">
                        ...
                        <span   class="align-middle">Pay Rs&nbsp<span id="bamount"></span></span>
                    </button>
                    <% } %>
                </form>
            </div>
        ...
        var aamount = document.getElementById('aamount');
        ...
        <script>
            var passFees = localStorage.getItem("passFees");
            var passRound = localStorage.getItem("passRound");

            //          amount=passFees;
            round.value = passRound;
            amount.value = passFees;

            bamount.innerHTML = passFees;
            aamount.innerHTML = passFees;
