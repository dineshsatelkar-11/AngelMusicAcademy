                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            StudentWiseVideo StudentWiseVideo=StudentWiseVideoDao.getStudentWiseVideoByID(id);
                                            %>
                                            <!--<iframe width="560" height="315" src="<%=StudentWiseVideo.getVideodescription()%>" frameborder="5" allowfullscreen></iframe>-->
