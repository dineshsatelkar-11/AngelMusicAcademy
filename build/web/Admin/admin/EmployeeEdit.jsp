                                ...
                                <form action="../../EmployeeUpdateServlet" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input type="text" value="<%=e.getName() %>" placeholder=" Name" id="name" name="name" class="form-control">
                                        </div>

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" value="<%=e.getMobileNo() %>" placeholder="Mobile" id="mobile" name="mobile" class="form-control priceup">
                                        </div>

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="email" value="<%=e.getEmail() %>" placeholder="Email" id="email" name="email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" value="<%=e.getAlternateNo() %>" placeholder=" Alternate No" id="alternateNo" name="alternateNo" class="form-control priceup">
                                        </div>

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" value="<%=e.getPermanentNo()%>" placeholder="Permanent No" id="PermanentNo" name="PermanentNo" class="form-control priceup">
                                        </div>

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" value="<%=e.getQualification() %>" placeholder="Qualification" id="qualification" name="qualification" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <textarea id="textarea"  required="required" name="addree" placeholder="Address" class="form-control col-md-7 col-xs-12"><%=e.getAddress() %></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                            <textarea id="textarea"  required="required" name="paddree" placeholder="Permanent Address" class="form-control col-md-7 col-xs-12"><%=e.getPermanentAddress() %></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" placeholder=" Designation " value="<%=e.getDesignation() %>" id="Designation" name="Designation" class="form-control">
                                        </div>

                                       

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" placeholder="salary" id="salary" value="<%=e.getSalary() %>" name="salary" class="form-control priceup">
                                        </div>
                                         <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                             <input type="text"  value="<%=e.getJoiningDate() %>" name="joinDate" readonly="" placeholder="Join Date" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">                                          
                                            <input type="text" readonly="" value="<%= e1.getAdminOfBranch().getBranchName() %>" placeholder="  Branch " id="Branch" name="Branch" class="form-control">
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" placeholder=" In Time " value="<%=e.getInTime() %>" id="intime" name="intime" class="form-control">
                                        </div>

                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                            <input type="text" placeholder="Out Time " value="<%=e.getOutTime() %>" id="outtime" name="outtime" class="form-control priceup">
                                        </div>
