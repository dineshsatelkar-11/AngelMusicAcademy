...
<%@page import="com.accede.angel.admin.model.AccountHistory"%>
<%@page import="com.accede.angel.admin.dao.AccountHistoryDao"%>
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ...
                                                    ExternalAccount es = ed.getExternalAccountByID(id);
                                                    AdminDao aa = new AdminDao();
                                                    AccountHistoryDao bd = new AccountHistoryDao();
                                                    Branch b = new Branch();
                                                    List<AccountHistory> c = bd.getProductModelByAccount(es);
                                                    for (AccountHistory p : c) {
                                                        j++;
                                            ...
                                            <td class="table_center" id="prd_name<%=j%>"><%=p.getExternalAccount().getAccountHolderName()%></td> 

                                            <td class="table_center" id="admin_designation<%=j%>"><%=p.getPaymentDate()%></td> 
                                            <td class="table_center" id="admin_email<%=j%>"><%=datespilt[1]%></td> 
                                            <td class="table_center" id="admin_mob<%=j%>"><%=p.getPaymentAgains()%></td> 
                                            <td class="table_center" id="admin_mob<%=j%>"><%=p.getAmount()%></td> 
                                            <td class="table_center" id="admin_mob<%=j%>"><%=p.getPaymentMode()%></td> 
                                            <td class="table_center" id="admin_mob<%=j%>"><%=p.getBankName()%></td> 
                                            <td class="table_center" id="admin_mob<%=j%>"><%=p.getTransctionNo()%></td> 
                                ...
                                <form action="../../UpdateExternalAcount" name="update" class="form-horizontal form-label-left">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="modal_admin_email"  name="modal_admin_email" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
