                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                    <form method="post" action="../../AddInstrument" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 <%
...
<div class="alert success">
  <span class="closebtn">&times;</span>  
  <strong>Success!</strong> Instrument Added Successfully.
</div>
<% }
     session.removeAttribute("i");
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="Instrument" name="Instrument" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Desc">Instrument Description<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Instrument Added Date </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center"><%=p.getInstrumentDescription()%></td> 
