                        ...
                        <div class="modal fade" id="CustomeDate" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask" method="post"  action="SuperAdminInOutVendor.jsp"  data-parsley-vdalidate>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" id="id" name="id" >
                                                    ...
                                                    <%                                                            Venderregistration v = new Venderregistration();
                                                        ...
                                                        List<Venderregistration> vr = dao.getAllVendor();
                                                        for (Venderregistration vv : vr) {
                                                            boolean b1 = vv.isStatus();
                                                            if (b1) {
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="row">
                                            ...
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                            <button onclick='window.top.location.href = "SuperAdminInOutVendor.jsp?Days=-3&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">All Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        String paymentAgainsType = "Vendor";
