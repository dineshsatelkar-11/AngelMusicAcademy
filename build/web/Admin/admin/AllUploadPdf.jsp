                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Name of Pdf </th>
                                                    <th class="table_center">Link of Pdf  </th>
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ...
                                                    List<UploadCoursePdfModel> c = UploadCoursePdfDao.getAllProduct();
                                                    for (UploadCoursePdfModel p : c) {
                                                        j++;
                                            ...
                                            <td class="table_center" id="admin_designation<%=j%>"><%=p.getNameofpdf()%></td> 
                                            <td class="table_center" id="admin_email<%=j%>"><%=p.getPdflink()%></td> 
