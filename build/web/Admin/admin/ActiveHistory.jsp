                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <% int j = 0;
                                                    ...
                                                    Employee b2 = bd.getEmployeeByID(Employeeid);
                                                    System.out.print(b2);
                                                    List<EmployeeActiveHistory> c = bd.getAllEmployeeActiveHistory(b2);
                                                    for (EmployeeActiveHistory p : c) {
                                                        j++;

                                                        String date1 = DATE_FORMAT.format(p.getActivedate());
                                                %>
                                                <tr>
                                                    ...
                                                    <td class="table_center"><%=p.getStatus()%></td>
