                ...
                <div  role="main">
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post" action="../../InstrumentRepairSave" id="demo-form2"  onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Instrument Repair Cost<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="example-modal">
                            <div class="modal" id="EditInstrumentedit">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="../../EditInstrumentRepair" name="update" data-parsley-validate>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <table  class="table table-striped">
                                                    ...
                                                    <th class="table_center">Instrument Repair Cost</th>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <td class="table_center" id="prd_rent<%=j%>"><%=p.getInstrumentRepairCost()%></td> 


                                            <td class="table_center"><a href="#EditInstrumentedit" role="button" data-toggle="modal" data-id="<%=j%>"><i id="<%=j%>" class="fa-2x glyphicon glyphicon-edit edit_prd"></i></a></td>

                                            <form id="from<%=j%>" action="../../DeleteInstrumentrepair">
      ...
      if (isConfirm) {
        ...
        swal("Cancelled", "Your Instrument  is safe :)", "error");
            ...
            function alpha(e) {
                ...
                return ((k > 64 && k < 91) || (k > 96 && k < 123) || k == 8 || k == 32|| k == 45);
            }
