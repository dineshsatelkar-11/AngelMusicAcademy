                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form action="../../ExternalAccountSuperAdmin" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="Account_Email_Id" class="form-control col-md-7 col-xs-12" type="text" name="Account_Email_Id">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Mobile No </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="Account_Mobile_No" class="form-control col-md-7 col-xs-12" type="text" name="Account_Mobile_No">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea id="Address" class=" form-control col-md-7 col-xs-12" required="required" name="Address" type="text"></textarea>
