                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ...
                                                    Branch b = new Branch();
                                                    List<ExternalAccount> c = bd.getAllAccountList();
                                            ...
                                            <td class="table_center" ><a href="ViewPaidAmmount.jsp?accountid=<%=p.getId() %>" class="btn btn-round btn-success btn-xs">View Payment History</a></td> 
