                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" data-parsley-validate enctype="multipart/form-data" 
                                              ...
                                              autocomplete="off" action="/AngelMusicAcademy/UploadEmployeeImages"
                                              method="post">
                                            ...
                                            <%
                                                ...
                                                <input type="hidden" id="customerAccountid" name="customerAccountid" value="<%=Eid%>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12">
                                                    <a href="ChangeEmployeePic1.jsp?asd=<%=Eid%>" class="btn btn-primary">
                                                     Open Camera
