                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post" action="../../EmployeeAdvanceSave" id="demo-form2"  onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="employeesalary" name="employeesalary" value="<%=ee.getAdvance()%>" readonly required="required" onkeypress="return alpha(event)" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ...
                                                    List<EmployeeAdavance> c =new  EmployeeAdvanceDao().getAllEmployeeAdavance(ee);
                                                    for (EmployeeAdavance p : c) {
                                                      
  String dateee  = DATE_FORMAT.format(p.getActivedate());
                                                            j++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center"><%=p.getActivetime()%></td> 
