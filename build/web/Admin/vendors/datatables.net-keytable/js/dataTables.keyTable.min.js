...
(function(e) {
    ...
    e.extend(l.prototype, {blur: function() {
            this._blur()
        }, enable: function(a) {
            this.s.enable = a
        }, focus: function(a, b) {
            ...
            if (this.s.enable) {
                if ("number" !== typeof a) {
                    var j = a.index(), b = j.column, a = f.rows({filter: "applied", order: "applied"}).indexes().indexOf(j.row);
        ...
        _tabInput: function() {
            ...
            if (-1 != d)
                e('<div><input type="text" tabindex="' + d + '"/></div>').css({position: "absolute", height: 1, width: 0, overflow: "hidden"}).insertBefore(b.table().node()).children().on("focus", function() {
