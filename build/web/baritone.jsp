    ...
    <body>
        <div id="wrapper" class="clearfix">
            ...
            <div class="main-content">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/barotone_banner.jpg">
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <iframe width="560" height="315" src="" frameborder="5" allowfullscreen></iframe>
...
<!--                                    <video id="videoElementID" autoplay="" class="pull-left flip mr-15 thumbnail" style="height:300px;width:400;" controls controlsList="nodownload">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The baritone horn, or sometimes just called baritone, is a low-pitched brass instrument in the saxhorn family. It is a piston-valve brass instrument with a bore that is mostly conical, like the flugelhorn and alto (tenor) horn, but is narrower than the conical bore of the euphonium.</p>
