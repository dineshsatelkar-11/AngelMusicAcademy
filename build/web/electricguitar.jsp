    ...
    <body>
        <div id="wrapper" class="clearfix">
            ...
            <div class="main-content">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/electricg_banner.jpg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    ...
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/OK9CJDtEY7o?rel=0" frameborder="5" allowfullscreen></iframe>
...
<!--                                    <video id="videoElementID" autoplay="" class="pull-left flip mr-15 thumbnail" style="height:300px;width:400;" controls controlsList="nodownload">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;An electric guitar is a fretted stringed instrument with a neck and body that uses a pickup to convert the vibration of its strings which are typically made of steel, and which occurs when a guitarist strums, plucks or fingerpicks the strings into electrical signals. The vibrations of the strings are sensed by a pickup, of which the most common type is the magnetic pickup, which uses the principle of direct electromagnetic induction.</p>
