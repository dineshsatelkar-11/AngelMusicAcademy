                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left"  enctype="multipart/form-data" action="../../UpdateLessonPdf" onsubmit="return validation(this)" method="post">
        ...
        <script type="text/javascript">
            $('#document').ready(function() {
                ...
                $("#course").change(function(event) {
                    ...
                    $.get("Fetchnooflessonajax1.jsp", {course: course}, function(data) {
                        //   alert('sucess');
                        $('#output11').html(data);
                    });
                });
