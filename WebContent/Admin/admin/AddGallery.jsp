                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form class="form-horizontal form-label-left"  enctype="multipart/form-data" action="../../AddPdfGallerySer" onsubmit="return validation(this)" method="post">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <%                AddPdfGalleryDao ld = new AddPdfGalleryDao();
                                        AddPdfGallery lf = new AddPdfGallery();
                                        List<AddPdfGallery> lessons = ld.getAllAddPdfGallery();

                                        int i = 0;
                                        for (AddPdfGallery l : lessons) {
