...
float debitamt=0;
                                                    for (VendorTransaction vv : v) {
                                                        if (vv.getVendor_Id() == v_id) {
                                                            String date1 = DATE_FORMAT.format(vv.getTransaction_Date());
                                                            i++;
...
creditamt=creditamt+vv.getTransactionAmount();
                                                    %>
                                                    <td class="table_center"><%=vv.getTransactionAmount()%></td>
                                                    <td></td>
                                                    <%} else {
       debitamt=debitamt+  vv.getTransactionAmount();                                           
                                                    %>
                                                    <td></td>
                                                    <td class="table_center"><%=vv.getTransactionAmount()%></td>
                                                    <%}%>  
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Balance:- <%=creditamt-debitamt%></th>
