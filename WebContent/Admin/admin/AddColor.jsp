                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post" action="../../AddColorServ" id="demo-form2"  onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Color Name<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="ColorName" name="ColorName" required="required" onkeypress="return alpha(event)" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal" id="myModal1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="../../EditColor" name="update">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" id="updateProduct"   >Edit Color</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- /.modal-content -->
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Edit Color  </th>


                                                    <th class="table_center">Delete Color  </th
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ColorDao bd = new ColorDao();
                                                    ColorModel ca = new ColorModel();
                                                    List<ColorModel> c = bd.getAllColorModel(ca);
                                                    for (ColorModel p : c) {
                                                        j++;
                                            ...
                                            <td class="table_center" id="prd_name<%=j%>"><%=p.getColorName()%></td> 

                                            <td class="table_center"><a href="EditColor.jsp?productid=<%=p.getId()%>" class="fa-2x glyphicon glyphicon-edit edit_prd" ></a></td>

                                            <form id="from<%=j%>" action="../../DeleteColor">
                                                                ...
                                                                document.querySelector('#from' + i).addEventListener('submit', function(e) {
                                                                    ...
                                                                    swal({
                                                                        ...
                                                                        if (isConfirm) {
                                                                            ...
                                                                            swal("Cancelled", "Your Color  is safe :)", "error");
                                                                        }
                                                                    })
                                                                });
                                                            }
