                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post" action="../../AddBrandServ" id="demo-form2"  onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="Brand" name="Brand" required="required" onkeypress="return alpha(event)" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal" id="myModal1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="../../EditBrand" name="update">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" id="updateProduct"   >Edit Brand</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- /.modal-content -->
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Edit Brand   </th>


                                                    <th class="table_center">Delete Brand   </th
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    ...
                                                    Brand ca = new Brand();
                                                    List<Brand> c = bd.getAllBrand(ca);
                                                    for (Brand p : c) {
                                                        j++;
                                            ...
                                            <td class="table_center" id="prd_name<%=j%>"><%=p.getBrand()%></td> 

                                           <td class="table_center"><a href="EditBrand.jsp?productid=<%=p.getId()%>" class="fa-2x glyphicon glyphicon-edit edit_prd" ></a></td>

                                            <form id="from<%=j%>" action="../../DeleteBrand">
