                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="item form-group smsport">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                ...
                                                <div class="col-md-6 " >        <form class="form-horizontal form-label-left"  action="../../UpdateProfileByCameraForEmployee"  method="post">
                                                    <input type="hidden" id="studentid" value="<%=Eid%>" name="studentid">
