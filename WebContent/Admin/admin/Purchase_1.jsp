                                            ...
                                            if (!(Brand === ""))
                                            {
                                                if (!(Model === ""))
                                                {
                                                    if (!(ColorName === ""))
                                                    {
                                                        ...
                                                        $.get("AjaxPages/AdProducTemp.jsp",
                                                                {Other_Charges: Other_Charges, Discount_Amount: Discount_Amount, gst_type: gst_type, GSt_per: GSt_per, Category: Category, Brand: Brand, Model: Model, ColorName: ColorName, MRP_PRice: MRP_PRice, purchase_price: purchase_price, Quantity: Quantity}, function(data) {
                                                            $('#Report_Fetch').html(data);
                                    ...
                                    <div class="x_content">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                                <div class="form-group">
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        %>
                                                        <input type="text" id="BillNo" name="BillNo" readonly="" value="Bill No-<%=new PurchaseDao().getLastPurchaseId()%>" required="required" placeholder="Bill No"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <input placeholder="Date Of Purchase" type="text" id="datetimepicker1" required=""  name="DateOfPurchase"  class="form-control ">
                                                    </div>
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <input type="text" id="InvoiceNo" name="InvoiceNo"  required="required" placeholder="Invoice  No"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">     
                                                ...
                                                <div id="output">
                                                    <div class="col-md-3 col-sm-12 col-xs-12">
                                                        <input type="text" id="Hsn" name="Hsn" readonly="" required="required" placeholder="Vendor Name"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                                    </div>   
                                                ...
                                                <div class="col-md-3 col-sm-12 col-xs-12">
                                                    <input placeholder="GST Percentage" type="text" id="GSt_per" name="GSt_per"  class="form-control ">
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                                                    ...
                                                    <div class="row">  
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            ...
                                                            <input type="text" id="CGST_Amount" name="CGST_Amount" readonly=""  placeholder="CGST_Amount"  class="form-control">  
                                                        </div>          
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <label class="text-center" >SGST Amount</label>
                                                            <input type="text" id="SGST_Amount" name="SGST_Amount" readonly="" placeholder="SGST_Amount"  class="form-control">  
                                                        </div>          
                                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                                            <label class="text-center" >IGST Amount</label>
                                                            <input type="text" id="IGST_Amount" name="IGST_Amount"  readonly="" placeholder="IGST_Amount"  class="form-control">  
                                                        </div>          
                                                    </div>   
                                                </div>   
