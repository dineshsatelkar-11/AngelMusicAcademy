                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form action="../../UpdateBalance" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select type="text" id="Vendor_Id" name="Vendor_Id" required="required" class="form-control col-md-7 col-xs-12">
                                            ...
                                            <div class="form-group" id="output">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12" >
                                                    <input type="text" id="Balance_Amount" name="Balance_Amount" readonly="" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Amount to be debited</label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Remaining Balance<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="Remaining_Amount" class=" form-control col-md-7 col-xs-12" readonly="" required="required" name="Remaining_Amount" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea id="remark" class=" form-control col-md-7 col-xs-12" required="required" name="remark" type="text">Purchase order against=:</textarea>
