...
<html lang="en">
                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask" action="../../AddEmployee" id="EmployeeReg" data-parsley-vdalidate>
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" id="name" name="name"  onkeypress="return alpha(event)" required="" placeholder=" Name" class="form-control">
 ...
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" id="mobile" name="mobile" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required placeholder="Mobile No" class="form-control">

                                            </div>
                                           
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" placeholder=" Alternate No" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="alternateNo" required name="alternateNo" class="form-control priceup">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="hidden" placeholder="Permanent No"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="PermanentNo" required name="PermanentNo" class="form-control priceup">
                                            ...
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" placeholder="salary" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="salary" name="salary" required class="form-control priceup">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <input id="addree" required="required" name="addree" placeholder="Address" class="form-control col-md-7 col-xs-12">
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <input id="paddree" required="required" name="paddree" placeholder="Permanent Address" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" placeholder=" Bank Name " onkeypress="return alpha(event)" required id="bankName" name="bankName" class="form-control">
                                            </div>
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" placeholder="Branch Name" id="branchName" required name="branchName" class="form-control">
                                            </div>
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" id="accNo" name="accNo"  onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Account Number" required class="form-control">
                                            </div>
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" placeholder=" Ifsc Code " id="ifscCode" name="ifscCode"  required class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                <input type="text" id="aadharNo" name="aadharNo" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="12" placeholder="Aadhar Number" class="form-control">
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                <input type="text" id="bankAddrss" required="required" name="bankAddrss" placeholder="Bank Address" class="form-control col-md-7 col-xs-12">
                                                                ...
                                                                var controls =
                                                                        {
                                                                            ...
                                                                            addree:
                                                                                    function()
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            $input.formError("Addreess cannot be greater than 150 characters long");
                                                                                            isValid = false;
                                                                                        }
                                                                                        else
                                                                                        {
                                                                            ...
                                                                            paddree:
                                                                                    function()
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            $input.formError("Permanent Address cannot be greater than 150 characters long");
                                                                                            isValid = false;
                                                                                        }
                                                                                        else
                                                                                        {
