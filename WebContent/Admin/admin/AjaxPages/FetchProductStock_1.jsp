                        ...
                        if (allProducts != null && allProducts.size() > 0) {
                            ...
                            for (BranchProduct products : allProducts) {
                                ...
                                if (products.getAdminid() == branchid) {
                                    ...
                                    if ((products.getProduct().getCategory().getId() == Categoryid) && (products.getProduct().getBrand().getId() == Brandid) && (products.getProduct().getColorModel().getId() == ColorNameid) && (products.getProduct().getModel().getId() == Modelid)) {
                                        i++;
