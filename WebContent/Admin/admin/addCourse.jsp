                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post"  action="../../AddCourse" id="demo-form2" onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="courseName">Course Name<span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="courseName" name="courseName" onkeypress="return alpha(event)" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
...
<!--                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <center > <span  style="color:red">The Course Name has  special characters. These are not allowed.</span></center >
                                                </div>-->
                                            </div>
                                        ...
                                        <div class="modal" id="Editcourse">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="../../EditCourse" name="update">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" id="updateProduct"   >Edit Course</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <!-- /.modal-content -->
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Edit Course Name </th>


                                                    <th class="table_center">Delete Course Name </th
                                            ...
                                            <tbody>
                                                ...
                                                <% int j = 0;
                                                    CourseDao bd = new CourseDao();

                                                    List<Course> c = bd.getAllCourse();
                                                    for (Course p : c) {
                                                        j++;

                                                %>
                                                <tr>
                                            <input type="hidden" value="<%=p.getCourseId()%>" id="prd_id<%=j%>">
                                            <td class="table_center"><%=j%> </td>
                                            <td class="table_center" id="prd_name<%=j%>"><%=p.getCourseName()%></td> 
                                            <td class="table_center"><a href="#Editcourse" role="button" data-toggle="modal" data-id="<%=j%>"><i id="<%=j%>" class="fa-2x glyphicon glyphicon-edit edit_prd"></i></a></td>

                                            <form id="from<%=j%>" class="swa-confirm" action="../../DeleteCourse" >
                                                <td class="table_center">
                                                    <input type="hidden" value="<%=p.getCourseId()%>" id="deletecourse" name="deletecourse">
  ...
  swal({
      ...
      if (isConfirm) {
        ...
        swal("Cancelled", "Your Course  is safe :)", "error");
                ...
                <!-- /footer content -->
            </div>  <script src="../production/css/Alertajax.js" type="text/javascript"></script>
        </div>
