                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        <%                                            int id = Integer.parseInt(request.getParameter("adminid"));
                                            ...
                                            Admin branchh = aa.getAdminByID(id);
                                            AdminPrevilleagesDao apd = new AdminPrevilleagesDao();
                                            AdminPrevilleages p1 = apd.getAdminPrevilleages(branchh, "2");
                                            AdminPrevilleages p2 = apd.getAdminPrevilleages(branchh, "3");
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Admin Previliage</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllAccounts()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllStudent()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isVanished()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllRentRequest()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllRepairing()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllEmployee()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isDailyInOut()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAllEnquiry()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isBatch_Timing()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isPackage()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isVendor_Account()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isSMS()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isSend_Promotional_SMS()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isBranch_Sell_Report()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isClass_Branch_Sell_Report()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isCustomer_Sell_Report()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isBranch_Product_Report()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isAvailable_Product()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isClass_Product_Stock_Report()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isTime_Table()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isExpense()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isEnquiry()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isNew_Account()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isBalance()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isEnquiryReport()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isPayemtReport()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isPreviliageTab()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isActivePackage()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isRentCostReport()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td class="table_center">
                                                        ...
                                                        <input type="checkbox" <%if (p1.isRepairCostReport()) {%>checked="checked" <%}%> id="admin-<%=i%>" class="admin" name="admin-<%=i%>" value="<%=i%>" class=" instrumentCheck ">
                                                    </td>
                                                    <td class="table_center">
