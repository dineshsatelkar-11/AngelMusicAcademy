                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask" action="../../StudentAdmissionUpdateServlet" id="StudentAdmissionForm" data-parsley-vdalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                <input type="text" class="form-control priceup row0" readonly="" value="Admission Fee-<%=p.getAdmissionFee()%>"  id="adfee" name="adfee" placeholder="Enter Fee" required>
                                                <input type="hidden" class="form-control priceup row0" value="<%=p.getAdmissionFee()%>"  id="AdmissionFee" name="AdmissionFee" placeholder="Enter Fee" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                <select class="form-control" id="Package" name="Package" >
                                                    ...
                                                    <%
                                                        ...
                                                        for (PackageCourse p1 : allPackageCourse) {

                                                            if (p.getPackageCourse().getId() == p1.getId()) {
                                                    %>

                                                    <option  selected="selected" value="<%=p1.getId()%>"><%=p1.getPackagename()%></option>
                                                    <%} else {
                                                    %>

                                                    <option value="<%=p1.getId()%>"><%=p1.getPackagename()%></option>
