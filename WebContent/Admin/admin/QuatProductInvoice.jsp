                                ...
                                <section class="content invoice">
                                        ...
                                        <table id="datatable-buttons"  class="table table-striped table-bordered tablesize">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center" style="text-align: center" colspan="2">Discount</td>  
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 " >
                                            ...
                                            <div class="col-xs-12 " >
                                            <div class="col-xs-8 " >
                                                <div class="row"><strong>Note:Ones Goods sold will not return or Exchange.</strong></div>
                                            </div>
                                        </div>
                                            <div class="col-xs-12 " >
                                            <div class="col-xs-8 " >
                                                <div class="row"><strong>Note:Quotation valid till 15 Days from given Date.</strong></div>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 " >
                                            <div class="col-xs-8 " >
