...
<div class="alert success">
  <span class="closebtn">&times;</span>  
  <strong>Success!</strong> Batch Time Added Successfully.
</div>
<% }
     session.removeAttribute("i");
    }%>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="batchtime">Batch Time <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="batchtime" name="batchtime" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Action </th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center"><%=p.getBatchTiming()%></td> 
                                                   
                                                    <td><button class='dclass btn btn-danger' id='<%=p.getBatchTimeId()%>' name='Dbatch'>Delete</button></td>
