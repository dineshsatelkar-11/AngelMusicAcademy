                            ...
                            <form action="../../UpdateProduct" method="post">
                                ...
                                <div>
                                    <%
                                        ...
                                        pd = pdo.getProductByID(productid);
                                        boolean status=true;
                                        if(pd.getPurchasePrice()>0 || pd.getProductquantity()>0 || pd.getUnitPrice()>0 || pd.getCgst()>0|| pd.getSgst()>0|| pd.getIgst()>0)
                                        {status=false;}
                                    %>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                                            <div class="col-md-7 col-sm-12 col-xs-12">                                                   
                                                                ...
                                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                                    <label >Select Category<span class="required">*</span>
                                                                    </label>
                                                                    <%
                                                                    if(!status)
                                                                    {%>
                                                                    
                                                                    <input type="hidden"  name="Category" id="Category" value="<%=pd.getCategory().getId()%>">
                                                                    <input type="text"  name="Categoryid" id="Categoryid" readonly="" class="form-control" value="<%=pd.getCategory().getCategory()%>">
                                                                    
                                                                    <%}else{
                                                                    %>
                                                                    <select type="text" name="Category" id="Category" required="" class="form-control">
                                                                        ...
                                                                        <%  CategoryDao dao = new CategoryDao();
                                                                            ...
                                                                            for (Category gm : model) {
                                                                                ...
                                                                                if (gm.getId() == pd.getCategory().getId()) {
                                                                    ...
                                                                    <input type="hidden"  name="subCategory" id="subCategory" value="<%=pd.getSubCategory().getId()%>">
                                                                    <input type="text"  name="subCategoryid" id="subCategoryid" readonly="" class="form-control" value="<%=pd.getSubCategory().getSubCategory()%>">
                                                                    ...
                                                                    <select type="text" name="subCategory" id="subCategory" required="" class="form-control">
                                                                     ...
                                                                     List<SubCategory> allSubcat=new SubCatDao().getAllSubCategorybycatname(pd.getCategory()); 
                                                                            for (SubCategory gm : allSubcat) {

                                                                                if (gm.getId() == pd.getSubCategory().getId() ) {
                                                                        %>

                                                                        <option selected="selected" value="<%=gm.getId()%>"><%=gm.getSubCategory()%></option>
                                                                        <%
                                                                                }else{%> 
                                                                        
                                                                          <option  value="<%=gm.getId()%>"><%=gm.getSubCategory()%></option>
                                                                ...
                                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                                    <label >Select Model<span class="required">*</span>
                                                                    </label>
                                                                    ...
                                                                    <input type="hidden"  name="Model" id="Model" value="<%=pd.getModel().getId()%>">
                                                                    <input type="text"  name="Modelid" id="Modelid" readonly="" class="form-control" value="<%=pd.getModel().getModelName()%>">
                                                            ...
                                                            <div class="col-md-5 col-sm-12 col-xs-12"> 
                                                                <div class="col-md-6 col-sm-4 col-xs-12">
                                                                    <label >Select Brand<span class="required">*</span>
                                                                    </label>
                                                                    ...
                                                                    <input type="hidden"  name="Brand" id="Brand" value="<%=pd.getBrand().getId()%>">
                                                                    <input type="text"  name="Brandid" id="Brandid" readonly="" class="form-control" value="<%=pd.getBrand().getBrand()%>">
                                                                ...
                                                                <div class="col-md-6 col-sm-4 col-xs-12">
                                                                    <label >Select Color Name<span class="required">*</span>
                                                                    </label>
                                                                    ...
                                                                    <input type="hidden"  name="ColorName" id="ColorName" value="<%=pd.getColorModel().getId()%>">
                                                                    <input type="text"  name="ColorNamed" id="ColorNamed" readonly="" class="form-control" value="<%=pd.getColorModel().getColorName()%>">
                                                                    
                                                                    <%}else{
                                                                    %>
                                                                    <select type="text" name="ColorName" id="ColorName"  class="form-control">
                                                                       
                                                                        <%  ColorDao cd = new ColorDao();
                                                                            ColorModel cmm = new ColorModel();
                                                                            List<ColorModel> cm = cd.getAllColorModel(cmm);
                                                                            for (ColorModel gm : cm) {
                                                                                if (gm.getId() == pd.getColorModel().getId()) {
                                                ...
                                                <input type="hidden" id="productname" onkeypress="return alpha11(event)"  name="productname" placeholder=" Product Name" required="required" class="form-control">
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <div class="col-md-4 col-sm-12 col-xs-12" align="left">
                                                                <label >Enter MRP Price<span class="required">*</span>
                                                                </label>
                                                                <input type="text"  id="Mrpprice" name="Mrpprice" value="<%=pd.getPurchasePrice()%>" onkeypress="return alpha(event)" required="required"  class="form-control priceup">                                                                                                                                                                                                                                                                                                               
                                                            </div>

                                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                                <label >Enter Sell Price<span class="required">*</span>
                                                                </label>
                                                                <input type="text"  id="Sellprice" name="Sellprice" onkeypress="return alpha(event)" required="required" value="<%=pd.getUnitPrice()%>"  class="form-control priceup">                                                                                                                                                                                                                                                                                                               
                                                            </div>
                                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                                <label >Enter Quantity<span class="required">*</span>
                                                                </label>
                                                                <input type="text" readonly="" id="productquantity"  name="productquantity" required="required" value="<%=pd.getProductquantity()%>"  class="form-control priceup" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                            </div>
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                                <label >Enter CGST <span class="required">*</span>
                                                                </label>
                                                                <input type="text" id="Cgst"  name="Cgst" onkeypress="return alpha(event)" required="required" value="<%=pd.getCgst()%>"  class="form-control priceup">
                                                            </div>
                                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                                <label >Enter SGST<span class="required">*</span>
                                                                </label>
                                                                <input type="text" id="Sgst"  name="Sgst" onkeypress="return alpha(event)" required="required" value="<%=pd.getSgst()%>"  class="form-control priceup">  
                                                            </div>
                                                            <div class="col-md-4 col-sm-3 col-xs-12">
                                                                <label >Enter IGST<span class="required">*</span>
                                                                </label>
                                                                <input type="text" id="Igst"  name="Igst" onkeypress="return alpha(event)" required="required" value="<%=pd.getIgst()%>"  class="form-control priceup"> 
                                                            </div>
                                                        </div>

                                                    </div>
                                                </div> 
                                                <input name="Discription" id="Discription" type="hidden" placeholder="Product Discription" class="form-control">
 ...
 <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#Category').change(function() {
                ...
                $.get("AjaxPages/FetchSubCategoryForEdit.jsp", {Category: Category,subCategory:subCategory}, function(data) {
                       alert('sucess');
