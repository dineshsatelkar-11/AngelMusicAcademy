                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form method="post" action="../../AddBatchTimings" id="demo-form2"  onsubmit="return valid();" data-parsley-validate class="form-horizontal form-label-left">
...
ColorModel ca=new ColorModel();
                                            ...
                                            <td class="table_center"><a href="#myModal1" role="button" data-toggle="modal" data-id="<%=j%>"><i id="<%=j%>" class="fa-2x glyphicon glyphicon-edit edit_prd"></i></a></td>
