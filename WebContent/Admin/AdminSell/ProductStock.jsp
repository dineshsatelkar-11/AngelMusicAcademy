                                    ...
                                    <div class="x_content table-responsive">
                                        ...
                                        <div id="output1">
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <td class="data_center"><a href="#myModal1" role="button" data-toggle="modal" data-id="<%=i%>"><i id="<%=i%>" class="fa-2x glyphicon glyphicon-print edit_prd"></i></a></td>
...
<!--                                                        <td class="data_center"><a href="PrintBarcode.jsp?Barcodeid=<%=products.getId()%>" target="_blank" class="btn btn-primary edit_prd"><i>Print</i></a></td>-->
                                                <!--<td class="data_center" id="prd_name<%=i%>"><%=products.getProductname()%></td>-->                                                   
            ...
            <div class="example-modal">
                <div class="modal" id="myModal2">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="../../UpdateStockProduct" name="update" class="form-horizontal form-label-left">
                                <%                                          if (session.getAttribute("i") != null) {
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="modal_prd_name1"  name="modal_prd_name1" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="modal_prd_bar"  name="modal_prd_bar" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
