                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <form action="../../EditModelNo" method="post">
                                ...
                                <div>
                                    <%
                                        ...
                                        AddModel pd = new AddModel();
                                        ModelDao pdo = new ModelDao();
                                                    ...
                                                    <div class="row" >
                                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                                            <div class="form-group">
                                                              ...
                                                              <input type="text" name="modal_prd_name" id="modal_prd_name" value="<%=pd.getModelName()%>" class="form-control table_center" >
