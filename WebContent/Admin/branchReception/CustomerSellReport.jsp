                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                            ...
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                            <button onclick='window.top.location.href = "CustomerSellReport.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                                    ...
                                                    if (Days != null) {
                                                        if (Days.equals("-1")) {
                                                            ...
                                                            if (adminfilter.getAdminId() != 0) {
                                                                ...
                                                                cl = cd.getCustomerSaleThisMonth(adminfilter);
                                                            } else {
                                                                cl = cd.getCustomerSaleThisMonth();
                                                            }
                                                        } else if (Days.equals("-2")) {

                                                            if (adminfilter.getAdminId() != 0) {
                                                                cl = cd.getCustomerSaleLastMonth(adminfilter);

                                                            } else {
                                                                cl = cd.getCustomerSaleLastMonth();
                                                            }

                                                        } else {
                                                            noofdays = Integer.parseInt(Days);
                                                            if (adminfilter.getAdminId() != 0) {
                                                                cl = cd.getCustomerSaleInoutt(adminfilter, noofdays);

                                                            } else {
                                                                cl = cd.getCustomerSaleInoutt(noofdays);
                                                        ...
                                                        if (FDate != null) {
                                                            if (FDate != "") {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getCustomerSaleInoutt(adminfilter, FromDate, ToDate);

                                                                } else {
                                                                    cl = cd.getCustomerSaleInoutt(FromDate, ToDate);
                                                                }

                                                            }
                                                        } else {
                                                            cl = cd.getAllCustomerSale(adminfilter);
                                                        }
