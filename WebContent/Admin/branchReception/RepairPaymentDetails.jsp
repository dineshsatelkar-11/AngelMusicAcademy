                        ...
                        <div class="x_content">
                            ...
                            <%                                    long id = Long.parseLong(request.getParameter("asd"));
                                ...
                                for (int k = 0; k < j; k++) {
                                  ...
                                  int totaldiscount= 0;
                                  int paidamountt= 0;
                                   for(RepairDetails q: admission.getRepairDetails() )
                                    {
                                    totaldiscount=totaldiscount+q.getDisamount();
                                    paidamountt=paidamountt+q.getTotaladvancedfee();
                                    }
...
%>
                            ...
                            <form action="../../UpdateRepairingPayment" onsubmit="return valid()" class="form-horizontal form-label-left" novalidate method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <center style="color: white">Already Paid </center>
                                        <input type="text" id="paidamountt" readonly=""  style="text-align: center;background-color: aqua" value="<%=paidamountt%>"  name="paidamountt"  class="form-control col-md-7 col-xs-12">
                                    </div>
                                    <input type="hidden" style="text-align: center"  id="Discount" value="0" name="Discount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 row0">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" readonly="" style="text-align: center;background-color: aqua" id="discAmount" value="0" name="discAmount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 row0">
                                  
                                      <div class="col-md-3">
                                        <center style="color: white">Previous Discount</center>
                                        <input type="number" readonly="" style="text-align: center;background-color: aqua" id="totaldiscount" value="<%=totaldiscount%>" name="totaldiscount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 row0">
                                    </div>
                                    <div class="col-md-3">
                                ...
                                if(admission.getRemaininFee()>0)
{
                                ...
                                %>
                                <div class="form-group fetchbutton">
