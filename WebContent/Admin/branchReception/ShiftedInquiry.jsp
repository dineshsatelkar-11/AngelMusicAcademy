                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Follow Up</th>
                                                     <th class="table_center">Shifted</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                 ...
                                                 {
                                                 %>
                                                  <td class="table_center"><a  class="btn btn-round btn-primary btn-xs">Shift To Admission</a></td>
                                                  <%}
                                                 else if(p.getEnquiryType().equals("Sell") )
                                                 {%>
                                                 
                                                  <td class="table_center"><a  class="btn btn-round btn-info btn-xs">Shift To Sell</a></td>
                                                  <%}
                                                 else if(p.getEnquiryType().equals("Repair") )
                                                 {%>
                                                  <td class="table_center"><a class="btn btn-round btn-warning btn-xs">Shift To Repair</a></td>
                                                  <%}
                                                 else 
                                                 {%>
                                                  <td class="table_center"><a class="btn btn-round btn-default btn-xs">Shift To Rent</a></td>
                                                    <%}%>
