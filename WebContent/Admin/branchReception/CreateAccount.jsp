...
<div class="modal fade" id="ExternalAccount" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left input_mask" action="../../ExternalAccountSave" id="ExtAccountCreate" data-parsley-vdalidate  >

                <div class="modal-body">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">First Name <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="ExFirst_Name" name="First_Name" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                    <br>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="ExtAccount_Mobile_No" name="Account_Mobile_No" required=""   required="required" class="form-control col-md-7 col-xs-12" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                    </div>
                    <!--          <p>Some text in the modal.</p>-->
                </div>
                <br>
                <div class="modal-body">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="ExtAccount_Email_Id"  name="Account_Email_Id" class="form-control col-md-7 col-xs-12" type="email" name="middle-name">
                    </div>
                    <!--          <p>Some text in the modal.</p>-->
                </div>
                <br>
                  <div class="modal-body">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="ExtAccount_Designation"  name="Account_Designation" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                    </div>
                    <!--          <p>Some text in the modal.</p>-->
                </div>
                <br>
                <div class="modal-body">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea id="ExtAccountAddress" name="AccountAddress" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text"></textarea>
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <table>
                            <tr>
                                ...
                                <td> <button type="submit" id="ExtAccountCreatebtn" class="btn btn-success">Submit</button></td>
            ...
            <div class="modal-footer">
                                                        ...
                                                        <div class="title_right">
                                                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                                                <div class="input-group">
                                                                    <input type="button" class="btn btn-success" data-toggle="modal" data-target="#ExternalAccount" placeholder="Search for..." value="Create Account">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="table_center">Edit Account </th>
                                                    ...
                                                    <th class="table_center">History</th>
                                            ...
                                            <td class="table_center"><a href="#EditVendorAccount" role="button" data-toggle="modal" data-id="<%=j%>"><i id="<%=j%>" class="fa-2x glyphicon glyphicon-edit edit_prd1"></i></a></td>
                                            ...
                                            <td class="table_center" ><a class="btn btn-round btn-success" href="PaidAmmount.jsp?accountid=<%=p.getId()%>">Payment</a></td> 
                                            <td class="table_center" ><a class="btn btn-round btn-success" href="ViewPaidAmmount.jsp?accountid=<%=p.getId()%>">Payment History</a></td> 
                ...
                <div class="example-modal">
                    <div class="modal" id="EditVendorAccount">
                        <div class="modal-dialog">
                            <div class="modal-content">
