    ...
    <body class="nav-md">
        <div class="container body">
            <div class="main_container">      <%@ include file = "../comman_files/branchReceptionSidebar.jsp" %>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2> <small>Instrument List</small></h2>
...
<th>#</th>
 ...
 <th scope="row"><%=j%></th>
                                                    ...
                                                    <td><input type="text" class="amtchange" id="repaircost-<%=j%>" required="" name="amt<%=j%>" value="<%=p.getInstrumentRepairCost()%>" ></td>
                                                    ...
                                                    <td><input type="text" id="remark<%=j%>" name="remark<%=j%>" value="<%=p.getInstrumentRemark()%>" ></td>
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <input  type="date"  value="<%=Repair.getDuedateSmsdate()%>" id="Return_by_Date" name="Return_by_Date"   class="form-control" >
                                                    </div>
