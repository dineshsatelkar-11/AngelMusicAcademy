    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12"> 
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-center">
                    ...
                    <label class="text-center" >Advance Amount</label>

                    <input type="text" id="Advance_Amount" name="Advance_Amount" value="<%=advanceamount%>"  readonly="" required="required" placeholder="Net_Amount"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                </div>
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-center">
                    ...
                    <input type="text" id="net_Advance_Amount" name="net_Advance_Amount" value="<%=grosstotal + otheramount - discountamo - advanceamount%>"  readonly="" required="required" placeholder="Net_Amount"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                </div>
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 text-center remsinglefee" id="cFeeRem">
                    <label class="text-center" > Paid Amount</label>

                    <input type="text" placeholder="Paid Amount" name="paidamt" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<%=paid%>" class="form-control priceup"   id="paidamt"  required>
                </div>
                <div class="col-md-2 col-sm-12 col-xs-12 text-center remsinglefee" id="cFeeRem">

                    <label class="text-center" > Balance Amount</label>
                    <input type="text" placeholder=" Balance Amount" readonly="" name="balamt" class="form-control"  value="<%=grosstotal + otheramount - discountamo - advanceamount - paid%>"  id="balamt"  required>
                </div>
                
                
                 <div class="col-md-2 col-sm-12 col-xs-12 text-center remsinglefee" id="cFeeRem">

                    <label class="text-center" > Next Payment Date</label>
                    <input type="date" placeholder=" Balance Amount"  name="nextpaymentdate" class="form-control"    id="nextpaymentdate"  >
                </div>
            </div>
