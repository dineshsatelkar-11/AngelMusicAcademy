                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_title">
                                        ...
                                        <label class="col-md-offset-6" id="position"><a href="CustomerSale.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs"> New Request </a><a href="ExchangeProductList.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs">Exchange</a><a href="ExchangeReport.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs">Exchange Report</a></label>
...
<!--                                                        <td><%=c1.getCustomername()%></td>
                                                        ...
                                                        <td><%=c1.getAdvance_Amount()%></td>
                                                        <td><%=c1.getPaidamt()%></td>
                                                        <td><%=c1.getBalamt()%></td>
                                                        <td><a href="PaymentHistory.jsp?purchaseid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>View History</i></a></td>
