                                ...
                                <section class="content invoice">
                                    ...
                                    <div class="row" >
                                        <div class="col-xs-12 invoice-header">  
                                            <div class="col-xs-3 invoice-header">

                                                <img src="../production/images/angle-music-logo.png"   alt=""/>
                                            </div>


                                            <div class="col-xs-9 invoice-header"  >
                                                <h1 style="color:red; ">
                                                ...
                                                <span style="color:#0275BA;"> ALL MUSICAL CLASSES INSTRUMENT,BAND, ACCESSORIES SALES & SERVICE</span>    
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 " >
                                            <div class="col-xs-8 " >
                                                <div class="row"><strong>Total Amount in words:-<%=amountinword%></strong></div>
                                            </div>
