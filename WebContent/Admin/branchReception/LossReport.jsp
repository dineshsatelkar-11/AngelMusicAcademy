                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>All Vanished Student Report </h2>   
                                    ...
                                    <!--                                                    <div class="x_title">
                                                                        ...
                                                                        <label class="col-md-offset-6" id="position">All Rent Request</label>
                                                                        <div class="clearfix"></div>
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="table_center">Student Name</th>
                                                        ...
                                                        <th class="table_center">View Profile</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <%                                                    List<StudentVanishHistory> allStudentVanishHistory = null;
                                                        ...
                                                        int q12 = 0;
                                                        int amount = 0;
                                                        allStudentVanishHistory = StudentVanishHistoryDao.getStudentVanishHistory(admin);
                                                        if (allStudentVanishHistory != null && allStudentVanishHistory.size() > 0) {
                                                            for (StudentVanishHistory p1 : allStudentVanishHistory) {

                                                                String date1 = DATE_FORMAT.format(p1.getFromDate());
                                                                q12++;
                                                                amount = amount + p1.getDeductionamount();
                                                    %>
                                                    <tr>
                                                        ...
                                                        <td class="table_center"><%=p1.getCustomerAccount().getName()%></td> 
                                                        ...
                                                        <td class="table_center"><a href="StudentProfileDetails.jsp?accountid=<%=p1.getCustomerAccount().getId()%>" class="btn btn-round btn-success btn-xs">Profile</a></td>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th class="table_center" style="" colspan="8"></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="table_center" colspan="7">Total</th>
