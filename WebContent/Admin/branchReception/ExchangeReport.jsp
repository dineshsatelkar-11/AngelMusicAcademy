                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div id="studentfetch">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Customer Sale Details</th>  
                                                        <th>Customer Exchange product</th>  
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Exchange> AllBrand1 = b1.getallExchange(CustomerAccount);
                                                        int i = 0;
                                                        for (Exchange c1 : AllBrand1) {
                                     ...
                                     <td><%=c1.getPurchaseDate()%></td>
                                     <td><%=c1.getExchangeDate()%></td>
                                                        <td><%=c1.getPurchasePrice()%></td>
                                                        ...
                                                        <td><a href="CustomerOrderDetails.jsp?exchangeid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>Customer Order Details</i></a></td>
                                                        <td><a href="CustomerSaleDetails.jsp?exchangeid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>Customer Sale Details</i></a></td>
                                                        <td><a href="CustomerExchangeProduct.jsp?exchangeid=<%=c1.getId()%>"  class="btn9 btn btn-success"><i>Customer Exchange Product</i></a></td>
                                                        <td><a href="ProductDetails.jsp?exchangeid=<%=c1.getId()%>" class="btn9 btn btn-success"><i>Product Details</i></a></td>
