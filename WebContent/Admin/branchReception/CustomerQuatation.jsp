    ...
    <script>
        $('#document').ready(function() {
            ...
            $('#barcode1').blur(function() {
                ...
                $.ajax({
                    url: "AjaxPages/CustomerQuatProductAjax.jsp",
                    type: "post",
...
//                        alert('success');
            ...
            $('.remove_prd').click(function(event) {
                ...
                swal({
                    ...
                    $.ajax({
                        url: "CustomerQuatProoductDeleteAjax.jsp",
                        type: "post",
                        data: {prdID: prdID},
                    })
                            .done(function(data) {
                ...
                <div  role="main">
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <form action="../../CustomerQuatationServlet1" method="post" onsubmit="return valid();">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="x_panel">
                                                <div class="x_title">
                                                    <h2>Customer Quatation Details</h2>
 ...
 <%    
                                        ...
                                        %>
                                                    ...
                                                    <input type="hidden" id="advance" name="advance" value="<%=CustomerAccount.getAdvanceAmount()%>">
 ...
 <input type="hidden" id="customerAccountid" name="customerAccountid" value="<%=id%>">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">                                                   
                                                            <div class="form-group">
                                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <input type="text" id="BillNo" name="BillNo" readonly="" value="Bill No-<%=new CustomerQuatationDAO().getLastBillSaleID()+1%>" required="required" placeholder="Bill No"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                                                </div>
                                                                <!--                                                                <div class="col-md-4 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">     
                                                            ...
                                                            <div class="col-md-8 col-sm-8 col-xs-12"> 
                                                                ...
                                                                <input type="email" id="Cust_Email" name="Cust_Email" required="required" placeholder="Customer Address" value="<%=CustomerAccount.getEmail()%>" class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
  ...
  <div class="row">
      ...
      <input type="hidden" id="Advance_Amount" name="Advance_Amount" value="0"  readonly="" required="required" placeholder="Net_Amount"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
              

                    <input type="hidden" id="net_Advance_Amount" name="net_Advance_Amount" value="0"  readonly="" required="required" placeholder="Net_Amount"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                    ...
                    <input type="hidden" placeholder="Paid Amount" name="paidamt" value="0" class="form-control"   id="paidamt"  required>
             
                    <input type="hidden" placeholder=" Balance Amount" readonly="" name="balamt" class="form-control"  value="0"  id="balamt"  required>
