...
<html lang="en">
    ...
    %>
    <script>
        window.open("Invoice_Cello.jsp?admissionid=<%=celloId%>");
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left"  enctype="multipart/form-data" action="../../OldStudentAdmission" onsubmit="return valid();" method="post">
                                            ...
                                            <div id="wizard" class="form_wizard wizard_horizontal">
                                                    ...
                                                    <div id="output">
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                                ...
                                                                <center > <span id="f_name" style="color:red"></span></center >
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                                ...
                                                                <center > <span id="l_name" style="color:red"></span></center >
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                                ...
                                                                <center > <span id="Nationality_" style="color:red"></span></center >
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                ...
                                                <div id="step-2">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                            <input type="text" id="datetimepicker5" name="Admission_Date"  placeholder="Admission Date" class="form-control">
                                                        </div>
                                                ...
                                                <div id="step-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text" id="datetimepicker6" name="payment_Date"  placeholder="Payment Date" class="form-control">
                                                    ...
                                                    <div class="row form-group" id="allfees">
                                                        <div class="col-md-4" id="cFeePaid">
                                                            ...
                                                            <input type="text"  class="form-control priceup row0" name="totaladvancedfee" id="totaladvancedfee" value="0"  placeholder=""  required>
                                                                ...
                                                                function valid()
                                                                {
                                                                    ...
                                                                    if (fname.match(letters))
                                                                    {
                                                                        if (lname.match(letters))
                                                                        {
                                                                            if (nationality.match(letters))
                                                                            {
                                                                                ...
                                                                                if (duration !== 0)
                                                                                {
                                                                                    ...
                                                                                    if (Paymentmode !== 0)
                                                                                    {
                                                                                        ...
                                                                                        {
                                                                                            document.getElementById("Pay_mode").innerHTML = "Payment Type is not Selected. These is not allowed.";
                                                                                            $("#paymode").focus();
                                                                                            return false
                                                                                        }
                                                                                    }
                                                                                    ...
                                                                                    {
                                                                                        document.getElementById("Payment_mode").innerHTML = "Payment Mode is not Selected. These is not allowed Before Selecting Courses.";
                                                                                        $("#Paymentmode").focus();
                                                                                        return false
                                                                                    }
                                                                                ...
                                                                                {
                                                                                    document.getElementById("duration_").innerHTML = "Course Duration is not Selected. These is not allowed before Joining Date Select.";
                                                                                    $("#duration").focus();
                                                                                    return false
                                                                                }
                                                                            }
                                                                            ...
                                                                            {
                                                                                document.getElementById("Nationality_").innerHTML = "The Nationality has special characters. These is not allowed.";
                                                                                $("#nationality").focus();
                                                                        ...
                                                                        {
                                                                            document.getElementById("l_name").innerHTML = "The Last Name has special characters. These is not allowed.";
                                                                            $("#lname").focus();
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        document.getElementById("f_name").innerHTML = "The First Name has special characters. These is not allowed.";
                                                                        $("#fname").focus();
...
//                                                                                 alert(rowcount);
                ...
                $('.row0').on('keyup change', function() {
                    ...
                    if ((parseInt(totalfee) - parseInt(discountamount)) >= parseInt(totaladvancedfee))
                    {
                        ...
                        $('#amountinword').val(converAmount(parseInt(totalfee) - parseInt(discountamount)));
                    } else
                    {
                        document.getElementById("Advance_paidd").innerHTML = "Enter Correct Amount";
                        $('#totalremfee').val(0);
                    }
                });
