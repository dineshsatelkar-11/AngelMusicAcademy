                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12" style="float:right;">
                          <div id="gender" class="btn-group" data-toggle="buttons">
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                <input type="radio" name="gender"  class="Add_Product" value="1"> &nbsp; Transfer From Branch &nbsp;
                            </label>
                            <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="gender" class="Add_Product" value="2"> Receive at Branch
                            </label>
                          </div>
                        </div>
                      </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>     <input type="radio" class="btn btn-default Add_Product" name="Today" value="0" >  Today </label>
                                                    ...
                                                    <label><button type="button" class="btn btn-default" data-toggle="modal" data-target="#CustomeDate" >Custom</button>
                                                        ...
                                                        <!--</div>-->
                                                        <input type="hidden" id="adminid" name="Branch" value="<%=admin.getAdminId()%>" >
                                                                ...
                                                                <table id="datatable" class="table table-striped table-bordered">
                                                                    ...
                                                                    <tbody>      
                                                                        ...
                                                                        <%                                                        BranchClassTransferDao pdo = new BranchClassTransferDao();
                                                                            ...
                                                                            allProducts = pdo.getAllBranchClassTransfer(admin);
                                                                            long totalq = 0;
    ...
    transfer=1;
               ...
               var noofdays = 2;
                ...
                $.get("AjaxPages/FetchProductTransfer.jsp",
                        {transfer:transfer,ColorName: ColorName, Category: Category, Brand: Brand, Model: Model, Branch: Branch, SubCategory: SubCategory,noofdays:noofdays,adminid:adminid}, function(data) {
               ...
               var Category = $('#Category').val();
                ...
                var ColorName = $('#ColorName').val();
                 ...
                 $.get("AjaxPages/FetchProductTransfer1.jsp",
                        {transfer:transfer,TDate:TDate,FDate:FDate,ColorName: ColorName, Category: Category, Brand: Brand, Model: Model, Branch: Branch, SubCategory: SubCategory,adminid:adminid}, function(data) {
