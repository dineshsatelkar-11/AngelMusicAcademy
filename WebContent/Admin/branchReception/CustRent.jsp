...
<html lang="en">
  ...
  <%     if (session.getAttribute("printInvoiceID") != null) {
            ...
            if (invoicefor.equals("Rent")) {
               
                  long Rentid = (Long) session.getAttribute("Rentid");
...
//                long repairid = Long.parseLong(repairid1);
    ...
    %>
    <script>
        window.open("Final_Rent.jsp?rentid=<%=Rentid%>");</script>
        <%
                }
            }
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <label class="col-md-offset-6" id="position"><a href="CustomerRent.jsp?accountid=<%=id%>" class="btn btn-round btn-info btn-xs"> New Request </a></label>
                                    <div class="clearfix"></div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                     ...
                                                     <th class="table_center">Deposit Amount</th>
                                            ...
                                            <tbody>
                                                ...
                                                <%
                                                    ...
                                                    int i = 0;
                                                    List<Rent> cl = null;
                                                    cl = RentDao.getAllRentRequestForCust(CustomerAccount);
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center"><%=p.getSecurityDeposite()%></td> 
                                                    <td class="table_center"><%=p.getReceivedDate()%></td> 
                                                  
                                                  
                                                  <td class="table_center"><a href="CustomerRentPayment.jsp?accountid=<%=p.getId()%>" class="btn btn-round btn-info btn-xs">Payment </a></td>
