                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        if (!(idd.equals("all"))) {
                                                            ...
                                                            Enquiry p = cd.getEnquiryByID(srrequestid);
                                                                 String date1 = DATE_FORMAT1.format(p.getFollowupDate());
                                                    %>
                                                    ...
                                                    <%
                                                        ...
                                                        List<Enquiry> allEnquiry = cd.getAllEnquiryFollowup(admin);
                                                        for (Enquiry p : allEnquiry) {
