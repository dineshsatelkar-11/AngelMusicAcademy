                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div id="studentfetch">
                                     ...
                                     <td><%=p.getCustomerSaleDetails().getDate() %></td>
                                     <td><%=p.getCustomerSaleDetails().getProductquantity() %></td>
                                                        <td><%=p.getCustomerSaleDetails().getGross_amount() %></td>
                                                        
                                                        
                                                        <td><%=p.getCustomerSaleDetails().getPurchasePrice()%></td>
                                                        <td><%=p.getCustomerSaleDetails().getMrpprice()%></td>
                                                        <td><%=p.getProduct().getCategory().getCategory() %></td>
                                     <td><%=p.getProduct().getSubCategory().getSubCategory() %></td>
                                                        <td><%=p.getProduct().getModel().getModelName() %></td>
                                                        
                                                        
                                                        <td><%=p.getProduct().getBrand()%></td>
                                                        <td><%=p.getProduct().getColorModel().getColorName() %></td>
                                                        <td><%=p.getProduct().getProductBarcode() %></td>
                                                        <td><%=p.getProduct().getUnitPrice()%></td>
                                                        <td><%=p.getProduct().getCgst()%></td>
                                                        <td><%=p.getProduct().getSgst()%></td>
                                                        <td><%=p.getProduct().getIgst()%></td>
