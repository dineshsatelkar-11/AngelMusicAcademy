                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <%                               String accountidd = request.getParameter("accountid");
                                                    ...
                                                    int w = 0;
                                                    List<PaymentFollowup> allPaymentFollowup1 = new PaymentFollowupDao().getAllPaymentFollowupByCust(CustomerAccount);
                                                    for (PaymentFollowup PaymentFollowup : allPaymentFollowup1) {
                                                        ...
                                                        for (PaymentFollowupMessage q : allPaymentFollowupMessage1) {
                                                         ...
                                                         SimpleDateFormat DATE_FORMAT1 = new SimpleDateFormat("dd-MM-yyyy");
                                                                 ...
                                                                 String date2 = DATE_FORMAT1.format(d);
