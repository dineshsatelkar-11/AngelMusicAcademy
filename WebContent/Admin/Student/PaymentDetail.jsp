                        ...
                        <div class="x_content">
                            <!--<form action="../../UpdateStudentPayment" onsubmit="return valid()" class="form-horizontal form-label-left" novalidate method="get">-->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <center >Name</center>
                                        <input id="name" class="form-control col-md-7 col-xs-12" style="text-align: center" value="<%=admission.getFirstName()%>" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="both name(s) e.g Jon Doe" required="required" type="text"> 
                                    </div>
                                    <div class="col-md-4">
                                        <center >Previous Balance</center>
                                        <input type="text" id="pbal" name="pbal" readonly="" style="text-align: center" value="<%=admission.getRemaininFee()%>" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                    <div class="col-md-4">
                                        <center >Course Fee</center>
                                        <input type="text" id="Course_fee" readonly=""  style="text-align: center" value="<%=coursefee%>"  name="Course_fee"  class="form-control col-md-7 col-xs-12">
                                    </div>
...
<!--                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" readonly="" style="text-align: center"  id="beforedisc" value="0" name="beforedisc" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" readonly="" style="text-align: center" id="discAmount" value="0" name="discAmount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12 row0">
                                    </div>
                                    <div class="col-md-3">
                                        <center >Final Amount </center>
                                        <input type="number" readonly="" style="text-align: center" id="totalAmount" value="0" name="totalAmount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>-->
...
<!--                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="number" readonly="" id="remaining_amount" style="text-align: center"  value="0" name="remaining_amount" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                                    </div>
                                    <div class="col-md-3">
