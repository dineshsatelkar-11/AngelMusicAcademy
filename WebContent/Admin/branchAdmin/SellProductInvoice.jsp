                            ...
                            <div class="x_content">
                                ...
                                <section class="content invoice">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 " >
                                            ...
                                            <div class="col-xs-2  "  style="float: right">
                                                ...
                                                <div class="row"><strong>Date :<%=ad.getDate() %></strong></div>
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="table_center"  style="text-align: center" colspan="2" ><span  >Final Amount</span></th>

                                                    <td class="table_center" style="text-align: center"><%=ad.getGrandtotal()%></td>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 " >
                                            <div class="col-xs-8 " >
                                                <div class="row"><strong>Total Amount in words:-Rs <%=ad.getAmount_inword()%>&nbsp;</strong></div>
                                            </div>
