    ...
    <body>
        <div id="wrapper" class="clearfix">
            ...
            <div class="main-content">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/tumpet_banner.jpg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                     ...
                                     <iframe width="560" height="315" src="https://www.youtube.com/embed/OvB48faENxI?rel=0" frameborder="5" allowfullscreen></iframe>
...
<!--                                    <video id="videoElementID" autoplay="" class="pull-left flip mr-15 thumbnail" style="height:300px;width:400;" controls controlsList="nodownload">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A trumpet is a musical instrument commonly used in classical and jazz ensembles. The trumpet group contains the instruments with the highest register in the brass family
