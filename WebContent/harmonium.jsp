    ...
    <body>
        <div id="wrapper" class="clearfix">
            ...
            <div class="main-content">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/harmonium_banner.jpg">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <ol class="breadcrumb asdfg white mt-10">
                                        <li ><a href="index.jsp" style="color:orange">Home</a></li>
                ...
                <section>
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/jBusdgKAxkg?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
<!--                                    <video id="videoElementID" autoplay="" class="pull-left flip mr-15 thumbnail" style="height:300px;width:400;" controls controlsList="nodownload">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The pump organ, reed organ, harmonium, or melodeon is a type of free-reed organ that generates sound as air flows past a vibrating piece of thin metal in a frame. The piece of metal is called a reed
                                        More portable than pipe organs, free-reed organs were widely used in smaller churches and in private homes in the 19th century, but their volume and tonal range are limited, and they generally had one or sometimes two manuals, with pedal-boards being rare. The finer instruments have a unique[peacock term] tone, and the cabinets of those intended for churches and affluent homes were often excellent pieces of furniture. Several million free-reed organs and melodeons were made in the USA and Canada between the 1850s and the 1920s. During this time Estey Organ and Mason & Hamlin were popular manufacturers.</p>
