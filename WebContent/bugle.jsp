    ...
    <body>
        <div id="wrapper" class="clearfix">
            ...
            <div class="main-content">
                ...
                <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bugle_banner.jpg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <p style="text-align:justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The bugle is one of the simplest brass instruments, having no valves or other pitch-altering devices. All pitch control is done by varying the player's embouchure. Consequently, the bugle is limited to notes within the harmonic series. See bugle call for scores to standard bugle calls, all consisting of only five notes. These notes are known as the bugle scale.
                                        <br /> 
