...
<html lang="en">
                        ...
                        <div class="modal fade" id="CustomeDate" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask" method="post"  action="SuperAdminEmployee.jsp"  data-parsley-vdalidate>
                                        ...
                                        <div class="modal-body">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="address">Select Employee<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="row">
                                            ...
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                            <button onclick='window.top.location.href = "SuperAdminEmployee.jsp?Days=-3&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">All Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <%
                                                        ...
                                                        String paymentAgainsType= "Employee";
                                                        ...
                                                        if (Days != null) {
                                                            if (Days.equals("-1")) {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    ...
                                                                    cl = cd.getPaymentThisMonth(BranchId,paymentAgainsType);
                                                                } else {
                                                                    cl = cd.getPaymentThisMonth(paymentAgainsType);
                                                                }
                                                            } else if (Days.equals("-2")) {

                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentLastMonth(BranchId,paymentAgainsType);

                                                                } else {
                                                                    cl = cd.getPaymentLastMonth(paymentAgainsType);
                                                                }

                                                            }else if (Days.equals("-3")) {

                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getAllPayment(BranchId,paymentAgainsType);

                                                                } else {
                                                                    cl = cd.getAllPayment(paymentAgainsType);
                                                                }

                                                            } else {
                                                                noofdays = Integer.parseInt(Days);
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentInoutt(BranchId,paymentAgainsType, noofdays);

                                                                } else {
                                                                    cl = cd.getPaymentInoutt(paymentAgainsType,noofdays);
                                                            ...
                                                            if (FDate != null) {
                                                                if (FDate != "") {
                                                                    ...
                                                                    if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentInoutt(BranchId,paymentAgainsType, FromDate, ToDate);

                                                                } else {
                                                                cl = cd.getPaymentInoutt(paymentAgainsType,FromDate, ToDate);
                                                                } 
 ...
 String agains = "";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table_center"><%=agains%></td>
