...
<!--                                                                    <div class="form-group">
 ...
 date1 = DATE_FORMAT.format(p1.getUploadedDate());
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="table_center"><%=p1.getCourseid()%></td> 


                                                                                        <td class="table_center"><%=p1.getPdfdescription()%></td> 

                                                                                        <td class="table_center">

                                                                    <!--<a href="../../DownloadPDF?asd=<%=p1.getPdfGalleryid()%>" class="btn btn-primary btn-sm">Download </a>-->
                                                                                            <!--
