                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div class="row">
                                            ...
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=0&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Today</button>
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Yesterday</button>
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=7&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last 7 Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=30&id=" + document.getElementById("Branch").value;'  class="btn btn-default" name="Today" value="1" type="button">Last 30 Days</button>
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=-1&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">This Month</button>
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=-2&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">Last Month</button>
                                            <button onclick='window.top.location.href = "DailyInOut.jsp?Days=-3&id=" + document.getElementById("Branch").value;' class="btn btn-default" name="Today" value="1" type="button">All Days</button>
                                            <!--                                                </div>
                                                                                            <div class="btn btn-default">-->
                                                        ...
                                                        if (Days != null) {
                                                            if (Days.equals("-1")) {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    ...
                                                                    cl = cd.getPaymentThisMonth(adminfilter);
                                                                } else {
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentLastMonth(adminfilter);
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getAllPayment(adminfilter);
                                                                ...
                                                                if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentInoutt(adminfilter, noofdays);
                                                            ...
                                                            if (FDate != null) {
                                                                if (FDate != "") {
                                                                    ...
                                                                    if (adminfilter.getAdminId() != 0) {
                                                                    cl = cd.getPaymentInoutt(adminfilter, FromDate, ToDate);
...
String date1 = DATE_FORMAT.format(p.getPaymentDate());
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table_center"><%=p.getCustomerAccount().getAdminOfBranch().getAdminOfBranch().getBranchName()%></td>
