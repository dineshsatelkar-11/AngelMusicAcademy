                                        ...
                                        <table id="datatable-buttons"  class="table table-striped table-bordered tablesize">
                                            ...
                                            <tbody>
                                                ...
                                                <%
                                                    ...
                                                    int q = noofcoursee1 + 2;
                                                %>


                                                <tr>
                                                    <td class="table_center" style="text-align: center">1</td>
                                                    <td class="table_center" style="text-align: center">Admission Fee</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center" style="text-align: center"><%=coursename1%></td>
                                                    <td class="table_center" style="text-align: center"><%=coursefee1%></td>  
                                                    <td class="table_center" style="text-align: center"><%=coursefee1 * paymentmodecount%></td> 
                                                </tr> 
                                                <%     }
                                                    if (noofcoursee1 >= 2) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center" style="text-align: center"><%=coursename2%></td>
                                                    <td class="table_center" style="text-align: center"><%=coursefee2%></td>  
                                                    <td class="table_center"style="text-align: center"><%=coursefee2 * paymentmodecount%></td> 
                                                </tr> 
                                                <%     }
                                                    if (noofcoursee1 >= 3) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center" style="text-align: center"><%=coursename3%></td>
                                                    <td class="table_center" style="text-align: center"><%=coursefee3%></td>  
                                                    <td class="table_center" style="text-align: center"><%=coursefee3 * paymentmodecount%></td> 
                                                </tr> 
                                                <%     }
                                                    if (noofcoursee1 >= 4) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center" style="text-align: center"><%=coursename4%></td>
                                                    <td class="table_center" style="text-align: center"><%=coursefee4%></td>  
                                                    <td class="table_center" style="text-align: center"><%=coursefee4 * paymentmodecount%></td> 
                                                </tr> 
                                                <%     }
                                                    if (noofcoursee1 >= 5) {
                                                ...
                                                <tr>
                                                    <td class="table_center" style="text-align: center">5</td>
                                                    <td class="table_center" style="text-align: center"><%=coursename5%></td>
                                                    <td class="table_center" style="text-align: center"><%=coursefee5%></td>  
                                                    <td class="table_center" style="text-align: center"><%=coursefee5 * paymentmodecount%></td> 
                                                </tr> 
                                                <%}%>
                                                <%
                                                    if (disamount > 0) {
                                                ...
                                                <tr>
                                                    <th class="table_center"   ></th>
                                                    <th class="table_center"   ></th>
                                                    <th class="table_center"  style="text-align: center"  ><span  >Balance Amount</span></th>

                                                    <td class="table_center" style="text-align: center"><%=totalremfee%></td>
