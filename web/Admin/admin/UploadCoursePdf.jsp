                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <form class="form-horizontal form-label-left input_mask" action="../../UploadCoursePdfServlet" data-parsley-vdalidate>
                                        <div class="x_content">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control" required id="course" name="course" >
                                                    ...
                                                    <option value="<%=f.getCourseId()%>"><%=f.getCourseName()%></option>
                                                    <%
                                                            count++;
                                                        }
                                        ...
                                        <div class="clearfix"></div>               
                                        <div class="x_content">
                                            <label for="nop" class="control-label col-md-3 col-sm-3 col-xs-12">Name of Pdf<span class="required">*</span>
                                            </label> 
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="nop" name="nop" required placeholder="Name of pdf" class="form-control">
                                        ...
                                        <div class="clearfix"></div>               
                                        <div class="x_content">
                                            <label for="lop" class="control-label col-md-3 col-sm-3 col-xs-12">Link of Pdf<span class="required">*</span>
                                            </label> 
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="lop" name="lop" required="" placeholder="Link of pdf" class="form-control">
