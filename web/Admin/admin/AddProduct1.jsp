    ...
    <script type="text/javascript">
        $('document').ready(function() {
            ...
            $('.Add_Product').change(function() {
                ...
                $.get("AjaxPages/FetchProductStockforavailable.jsp",
                        {Category: Category, Brand: Brand, Model: Model , SubCategory :SubCategory ,ColorName :ColorName}, function(data) {
                    $('#output1').html(data);
...
<!--                                                        <td class="data_center"><a href="PrintBarcode.jsp?Barcodeid=<%=products.getId()%>" target="_blank" class="btn btn-primary edit_prd"><i>Print</i></a></td>-->
            ...
            <!-- /page content -->    <div class="example-modal">
                <div class="modal" id="PrintBarcode">
