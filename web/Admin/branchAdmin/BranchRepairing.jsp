...
<html lang="en">
    ...
    %>
    <script>
        window.open("Invoice_Repairing.jsp?repairing_id=<%=celloId%>");
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" action="../../AddRepairing" onsubmit="return valid();" method="post">
                                            <%                                                String Name = "";
                                                String Contact = "";
                                                String Email = "";
                                                    ...
                                                    <div id="output">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                                ...
                                                                <center > <span id="cust_addres" style="color:red"></span></center >
                                                            </div>
                                                        ...
                                                        <!--                                                            <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                                                                                        <input type="text" id="customerIdProof" name="customerIdProof" placeholder="customerIdProof"  class="form-control">
                                                                                                                    </div>  
                                                ...
                                                <div id="step-2">
                                                    ...
                                                    <div class="row form-group" id="allfees0">
                                                        <div class="col-md-7" >
                                                            ...
                                                            <div class="col-md-4" >
                                                                <input type="text"   class="form-control row0 priceup" value="0" name="CourseFee0" id="CourseFee0" placeholder="Reparing Cost" required>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Brandname0" placeholder="Brand Name" onkeypress="return alpha(event)" id="Brandname0" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5" >
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Modelname0" placeholder="Model Number" id="Modelname0" class="form-control  "   >
                                                            </div>
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Problem0" id="Problem0"  placeholder="Problem" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                    <div class="row form-group" id="allfees1">
                                                        <div class="col-md-7" >
                                                            ...
                                                            <div class="col-md-4" >
                                                                <input type="text"   class="form-control row0 row1 priceup"  value="0" name="CourseFee1" id="CourseFee1" placeholder="Reparing Cost" required>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Brandname1" placeholder="Brand Name" onkeypress="return alpha(event)" id="Brandname1" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5" >
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Modelname1" placeholder="Model Number" id="Modelname1" class="form-control  "   >
                                                            </div>
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Problem1" placeholder="Problem" id="Problem1" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                    <div class="row form-group" id="allfees2">
                                                        <div class="col-md-7" >
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Coursename2" id="Coursename2" class="form-control priceup"   readonly>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"  name="CourseFee2" id="CourseFee2" class="form-control row0 row1 priceup"  value="0"  placeholder="Reparing Cost" required>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Brandname2" placeholder="Brand Name" onkeypress="return alpha(event)" id="Brandname2" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5" >
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Modelname2" placeholder="Model Number" id="Modelname2" class="form-control  "   >
                                                            </div>
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Problem2" id="Problem2" placeholder="Problem" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                    <div class="row form-group" id="allfees3">
                                                        <div class="col-md-7" >
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Coursename3" id="Coursename3" class="form-control priceup"   readonly>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"  name="CourseFee3" id="CourseFee3" class="form-control row0 row1 priceup"  value="0"  placeholder="Reparing Cost" required>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Brandname3"  placeholder="Brand Name" onkeypress="return alpha(event)" id="Brandname3" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5" >
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Modelname3" placeholder="Model Number" id="Modelname3" class="form-control  "   >
                                                            </div>
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Problem3" id="Problem3" placeholder="Problem" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                    <div class="row form-group" id="allfees4">
                                                        <div class="col-md-7" >
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Coursename4" id="Coursename4" class="form-control priceup"   readonly>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"  name="CourseFee4" id="CourseFee4" class="form-control row0 row1 priceup"  value="0"  placeholder="Reparing Cost" required>
                                                            </div>
                                                            <div class="col-md-4" >
                                                                <input type="text"   name="Brandname4" placeholder="Brand Name" onkeypress="return alpha(event)" id="Brandname4" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-5" >
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Modelname4" placeholder="Model Number" id="Modelname4" class="form-control  "   >
                                                            </div>
                                                            <div class="col-md-6" >
                                                                <input type="text"   name="Problem4" id="Problem4" placeholder="Problem" class="form-control  "   >
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                    <br>
                                                    ...
                                                    <div class="row form-group" id="allfees">
                                                        ...
                                                        <div class="col-md-4 ">
                                                            ...
                                                            <input type="text" id="datetimepicker4" required="" name="joindate"  placeholder="Due Date" class="form-control">
                                                        </div>
...
//                                                                                 alert(rowcount);
                ...
                $('.row0').on('keyup change', function() {
                    ...
                    $('#finalamount').val(parseInt(totalcoursefee) - parseInt(discountamount));

                    document.getElementById("adva_paid").innerHTML = "";
                    if ((parseInt(totalcoursefee) - parseInt(discountamount)) >= parseInt(totaladvancedfee))
                    {
                        $('#totalremfee').val(parseInt(totalcoursefee) - parseInt(discountamount) - parseInt(totaladvancedfee));
