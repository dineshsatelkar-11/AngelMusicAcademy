    ...
    <body class="nav-md footer_fixed">
        <div class="container body">
            <div class="main_container">
                <div class="col-md-3 left_col">
                  <%@ include file = "../comman_files/branchReceptionSidebarForBilling.jsp" %>
</div>
                <!-- top navigation -->
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="row" id="tablefetch">
                            ...
                            List<CustomerSale> AllBrand1 = b1.getAllCustomerSale(admin);
                            int i = 0;
        ...
        <script type="text/javascript">
            ...
            $('.search').click(function (event) {
                ...
                $.ajax({
                    url: "CustomerSaleReportFetchAjax.jsp",
                    type: "post",
                    data: {start: start, end: end ,adminid :adminid},
