...
<script type="text/javascript">
    $(document).ready(function() {
        //  alert('adsjhfgadsf');
        $('.productchange2').blur(function(event) {
...
<%
   long quantity = Long.parseLong(request.getParameter("quantity"));
    ...
    float discount1 = Float.parseFloat(request.getParameter("discount1"));
   ...
   if(tc1==null)
   {
       ...
       tc.setDiscount(discount1);
       tc.setProductquantity(quantity);
       float discountprice =( mrpprice * discount1)/100;
       
       
       tc.setDiscountamount(discountprice);
       price1 = mrpprice - discountprice;
       float price = price1*quantity;
             ...
             %>                                                       
                                   <tr>
                                       ...
                                       <td  class="data_center"><input type="text" name="dis-<%=i%>" class="productchange1" value="<%= c1.getDiscount()%>" id="dis-<%=i%>"></td>                
                                         <td  class="data_center"><input type="text" name="dis-<%=i%>" class="productchange3" value="<%= c1.getDiscountamount()%>" id="dis-<%=i%>"></td>                
