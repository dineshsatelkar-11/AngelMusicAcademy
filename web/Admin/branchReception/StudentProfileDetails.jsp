...
<%    if (session.getAttribute("printInvoiceID") != null) {
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                            ...
                                            <ul class="list-unstyled user_data">
                                                ...
                                                <%
                                                    ...
                                                    String date1 = DATE_FORMAT.format(p.getNextPaymentDate());


                                                %>
                                                <li><i class="fa  fa-calendar  user-profile-icon"></i> Due Date <%=date1%>
                                                </li>
                                            </ul>

                                            <a href="StudentProfile.jsp?accountid=<%=CustomerAccount.getId()%>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                                            <a href="ChangeProfilePic_1.jsp?accountid=<%=CustomerAccount.getId()%>" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Change Profile Pic</a>
                                            <br />
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                                <ul id="myTab" class="nav nav-tabs bar_tabs responsive" role="tablist">
                                                    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Balance</a>
                                                    </li>

                                                    <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Monthly Payment</a>
                                                    </li>
                                                    <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Vanished Student</a>
                                                    </li>
                                                    <li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false">Upload PDF</a>
                                                    </li>
                                                    <li role="presentation" class=""><a href="#tab_content5" role="tab" id="profile-tab4" data-toggle="tab" aria-expanded="false">Upload Video</a>
                                                    </li>
 ...
 <div class="x_content">
                                                            <form action="../../StudentMonthlyPayment"  class="form-horizontal form-label-left" id="myForm" method="post">
                                                                <span class="section">Payment Info</span>
                                                                <input type="hidden" value="<%=id%>" id="custid" name="custid">
                                                              <input type="hidden" id="sessionidd" name="sessionidd" value="<%=sessionidd%>">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3" id="nextfollow">
                                                                        <center >Next Payment Date  </center>
                                                                        <input type="date" id="datetimepicker12" readonly="" style="text-align: center"  name="nextFollowdate" placeholder="Next Follow Up Date" class="form-control">
                                                                    </div>
                                                                    <div class="col-md-3" id="nextfollow1">
                                                                        <center >Next Payment Date  </center>
                                                                        <input type="date" id="nextpaymentdate"  style="text-align: center"  name="nextpaymentdate" placeholder="Next Follow Up Date" class="form-control">
                                                                    </div>
                                                                    <div class="col-md-3">
                                                                        <br>
                                                                        <button type="reset" class="btn btn-primary">Reset</button>
                                                                        <button type="submit" id="coursepaymentbtn" class="btn btn-success">Submit</button>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                                                        ...
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <form class="form-horizontal form-label-left" data-parsley-vdalidate  action="../../ShiftToOldStudentWithFee" onsubmit="return valid();" method="post">
 ...
 <input type="hidden" id="sessionidd" name="sessionidd" value="<%=sessionidd%>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput1">
                                                                            <input type="text" id="PreviousBalance" name="PreviousBalance" style="width:326px;" readonly=""  value="<%=p.getRemaininFee()%>" required="required" class="form-control ">

                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Enter Deduction Amount</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput1">
                                                                            <input type="text" id="deductionBalance" name="deductionBalance" style="width:326px;"   value="<%=p.getRemaininFee()%>" required="required" class="form-control ">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput1">
                                                                            <input type="date" id="fromdate" name="fromdate" style="width:326px;"    required="required" class="form-control ">

                                                                        </div>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Next Coming  Date</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput1">
                                                                            <input type="date" id="nextdate" name="nextdate" style="width:326px;"    required="required" class="form-control ">
                                                                        ...
                                                                        <table id="datatable" class="table table-striped table-bordered">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="table_center">From Date</th>
                                                                                    <th class="table_center">Till Date</th>
                                                                                    <th class="table_center">Previous Balance</th>
                                                                                    <th class="table_center">Deduction Amount</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <%                                                    List<StudentVanishHistory> allStudentVanishHistory = null;
                                                                                    StudentVanishHistoryDao StudentVanishHistoryDao = new StudentVanishHistoryDao();
                                                                                    int q12 = 0;

                                                                                    allStudentVanishHistory = StudentVanishHistoryDao.getStudentVanishHistory(CustomerAccount);
                                                                                    if (allStudentVanishHistory != null && allStudentVanishHistory.size() > 0) {
                                                                                        for (StudentVanishHistory p1 : allStudentVanishHistory) {
                                                                                             date1 = DATE_FORMAT.format(p1.getFromDate());
                                                                                            q12++;

                                                                                %>
                                                                                <tr>

                                                                                    <td class="table_center"><%=q12%> </td>


                                                                                    <td class="table_center"><%=p1.getStatus()%></td> 


                                                                                    <td class="table_center"><%=date1%></td> 
                                                                                    <%
                                                                                        if (p1.getStatus().equals("Shifted to Regular")) {
                                                                                    %>
                                                                                    ...
                                                                                    date1 = DATE_FORMAT.format(p1.getTillDate());
                                                                                    %>
                                                                                    <td class="table_center"><%=date1%></td> 
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab_content4" aria-labelledby="profile-tab">
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <form class="form-horizontal form-label-left" data-parsley-vdalidate  action="../../UploadPDFStudentWise" onsubmit="return valid();" method="post">
 ...
 <input type="hidden" id="sessionidd" name="sessionidd" value="<%=sessionidd%>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                            <select class="form-control" required="" id="courseIDForPDf" name="courseID" style="width:326px;">
                                                                    ...
                                                                    <div id="output11">
                                                                        ...
                                                                        <div id="output12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutputfetch">
 ...
 date1 = DATE_FORMAT.format(p1.getUploadedDate());
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="table_center">
                                                                                            ...
                                                                                            <a href="<%=p1.getUploadCoursePdfModel().getPdflink()%>" target="blank" class="btn btn-primary btn-sm">Download </a>
                                                    ...
                                                    <div role="tabpanel" class="tab-pane fade" id="tab_content5" aria-labelledby="profile-tab">
                                                        <div class="x_panel">
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <form class="form-horizontal form-label-left"   action="../../UploadStudentVideo" onsubmit="return validation(this)" method="post">
 <input type="hidden" id="sessionidd" name="sessionidd" value="<%=sessionidd%>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Course</label>
                                                                        <div class="col-md-9 col-sm-9 col-xs-12" >
                                                                            <select class="form-control" required="" id="courseID" name="courseID" style="width:326px;">
                                                                                <option value="">-Select Course-</option> 
                                                                                <%
                                                                    ...
                                                                    <div id="output11">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                <textarea id="description"  placeholder="Enter PDF Description" required="required" class="form-control" name="description" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 caracters long comment.."
                                                                                          data-parsley-validation-threshold="10" style="width:326px;"></textarea>

                                                                            </div>
                                                                        </div>
                                                                        <div id="output12">
                                                                            <div class="form-group">
                                                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="branchname">Enter Video Link <span class="required">*</span>
                                                                                </label>
                                                                                <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput">
                                                                                    <input type="text"  name="link"  id="link" required="" style="width:326px;" class="form-control">
                                                                        ...
                                                                        <div id="output12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9 col-sm-9 col-xs-12" id="pdfoutput">
                                                                                    <input type="date"  name="Date_of_Video"  id="Date_of_Video" required="" style="width:326px;" class="form-control">
                                                    ...
                                                    <div class="x_content">
                                                        ...
                                                        <table id="datatable-buttons" class="data table table-striped no-margin">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <%    
//                                                                                        List<StudentAccount> studentaccountlist=p.getStudentAccount();
//                                                                                        Collections.sort(studentaccountlist, Collections.reverseOrder());
                                                                                        i = 0;
                                                                    for (StudentAccount p1 : p.getStudentAccount()) {
                                                                        i++;
                                                                         date1 = DATE_FORMAT.format(p1.getPaymentDate());
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="table_center"><%=date1%> </td>
                                                                    <%
                                                                     date1 = DATE_FORMAT.format(p1.getNextPaymentDate());
                                                                    ...
                                                                    <td class="table_center"><a href="Perticular_invoice.jsp?admissionid=<%=p.getAdmissionId()%>&invoiceid=<%=p1.getAccountId()%>" target="blank"><i class="glyphicon glyphicon-print"></i></a></td> 
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#courseIDForPDf").change(function(event) {

                    var course = $('#courseIDForPDf').val();

                    var studentid = $('#studentid').val();

                    $.get("AjaxPages/FetchPdf.jsp", {course: course, studentid: studentid}, function(data) {

                        $('#pdfoutputfetch').html(data);
