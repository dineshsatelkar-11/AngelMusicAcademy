                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        %>
                                        <form class="form-horizontal form-label-left input_mask" action="../../CustRepairPayment" id="CustrepairPayment" data-parsley-vdalidate>
                                            ...
                                            <div id="FetchAmount" >
                                                ...
                                                <table id="datatable-checkbox"  class="table table-striped table-bordered bulk_action  text-center">
                                                   ...
                                                   <td name="amt<%=j%>"><%=p.getInstrumentRepairCost()%></td>
                                                    <td name="brand<%=j%>"><%=p.getInstrumentBrand()%></td>
                                                    <td name="model<%=j%>"><%=p.getInstrumentModel()%></td>
                                                    <td name="remark<%=j%>"><%=p.getInstrumentRemark()%></td>
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-12 col-xs-12 " style="padding: 0px">
                                                            ...
                                                            <input value="<%=Repair.getDiscper()%>"  type="text"  id="discper" name="discper" maxlength="10" placeholder="Contact No." class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>

                                                        </div>
                                                        <div class="col-md-6 col-sm-12 col-xs-12 " style="padding: 0px">
                                                            <p><strong>   Discount in Amount:</strong></p>
                                                            <input value="<%=Repair.getDiscamt() %>"  type="text" id="discamt" name="discamt" maxlength="10" placeholder="Contact No." class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                                    ...
                                                    <button type="submit" id="CustrepairPaymentbtn" class="btn btn-success">Submit</button>
                                                </div>
                                            </div>
                                            <%}%>
                                        </form>
                                                                        ...
                                                                        $("#CustrepairPaymentbtn").click(
                                                                                function(event)
                                                                                {
                                                                                    ...
                                                                                    if (validate.all())
                                                                                    {
                                                                                        ...
                                                                                        document.getElementById("CustrepairPayment").submit();
