                ...
                <div  role="main">
                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <form action="../../CustomerSaleServlet1" method="post" onsubmit="return valid();">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12"> 
            <div class="col-md-5 col-sm-12 col-xs-12 text-center">
                <div class="col-md-6 col-sm-12 col-xs-12 text-center">
                    ...
                    <input type="text" id="Advance_Amount" name="Advance_Amount" value="<%=CustomerAccount.getAdvanceAmount() %>"  readonly="" required="required" placeholder="Net_Amount"  class="form-control">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
                </div>
