            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>      
                    ...
                    <%                                                        BranchProductDao pdo = new BranchProductDao();
                        ...
                        allProducts = pdo.getAllProduct(id, Categoryid, SubCategoryid, Brandid, Modelid, Colorid);
...
<!--                                                        <td class="data_center"><a href="PrintBarcode.jsp?Barcodeid=<%=products.getId()%>" target="_blank" class="btn btn-primary edit_prd"><i>Print</i></a></td>-->
                <td class="data_center"> <a href="#SendStock" role="button" data-toggle="modal" id="<%=i%>" ><i class="fas fa-exchange-alt sendstockother"></i></a></td>
