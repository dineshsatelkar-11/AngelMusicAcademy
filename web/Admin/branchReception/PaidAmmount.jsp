                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form  method="post" action="../../AddAccountHistory" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            %>
                                            <input type="hidden" id="accountid" name="accountid" value="<%=es.getId()%>">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="paymentAgains" name="paymentAgains1" readonly="" value="<%=es.getAccountHolderName()%>" placeholder="Payment Agains" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="paymentAgains" name="paymentAgains2"  readonly="" value="<%=es.getDesignation()%>" placeholder="Payment Agains" required="required" class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="amount" placeholder="Enter Amount " name="amount" required="required" class="form-control col-md-7 col-xs-12" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="hidden" id="bankName" placeholder="Bank Name " name="bankName"  class="form-control col-md-7 col-xs-12">
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="hidden" id="transctionno" name="transctionno" placeholder="Transction No" class="form-control col-md-7 col-xs-12">
                                                </div>
                                        

                                            <div class="ln_solid"></div>
                                           <%
                                                if (es.getActive().equals("1")) {
                                            %>
                                            <div class="form-group">
