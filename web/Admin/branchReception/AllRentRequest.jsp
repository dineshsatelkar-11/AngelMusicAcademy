                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                   ...
                                                   <th class="table_center">Return Date</th>
                                                    <th class="table_center">Return Time</th>
                                            ...
                                            <tbody>
                                                ...
                                                <%
                                                    ...
                                                    int i = 0;
                                                    List<Rent> cl = null;
                                                    cl = cd.getAllRentRequestForAdmin(admin);
                                                    String instr="";
                                                    if (cl != null && cl.size() > 0) {
                                                        for (Rent p : cl) {
                                                  
                                                                boolean re=true;
                                                     Date dt = p.getReceivedDate();
                                                                String dd = dt.toString();
                                                                String[] datespilt = dd.split(" ");
    SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");  
    String strDate = formatter.format(p.getReceivedDate());  
                                                     
                                                    
                                                    if(re){
                                                            i++;
                                                            for(RentDetails r:p.getRentDetails() )
                                                            {
                                                            instr=instr+r.getInstrumentName();
                                                            instr=instr+",";
                                                            }
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table_center">   <%if(p.isCloseRequest())
                                                        {%>
                                                    ...
                                                    <td class="table_center"><%=p.getPaid_ByCust()%></td> 
                                                    <td class="table_center"><%=strDate%></td> 
                                                    <td class="table_center"><%=datespilt[1]%></td>
                                                    <td class="table_center"><%=instr%></td> 
                                                  
                                                  <td class="table_center"><a href="CustomerRentPayment.jsp?accountid=<%=p.getId()%>" class="btn btn-round btn-success btn-xs">Payment </a></td>
                                                ...
                                                <!--<td class="table_center"><input type="submit" class="btn btn-round btn-success btn-xs" value="Delete "></td>-->
                                                    ...
                                                    <td class="table_center"><a href="Final_Rent.jsp?rentid=<%=p.getId()%>" target="blank"><i class="glyphicon glyphicon-print"></i></a></td> 
