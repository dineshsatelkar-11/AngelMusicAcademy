                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="x_content">
                            ...
                            <form action="../../UpdateRentPayment" onsubmit="return valid()" class="form-horizontal form-label-left" data-parsley-validate method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" style="text-align: center"  placeholder="Cheque No/Transction No" name="chequeno" class="form-control"     id="chequeno"  >
                                    </div>
                                    <div class="col-md-4">
                                ...
                                $(document).ready(function () {
                                    ...
                                    $('.row0').on('keyup change', function () {
                                        ...
                                        if (parseInt(totalAmount) > parseInt(prepaidamount))
                                        {
                                            ...
                                            paidAmount = parseInt(totalAmount) - parseInt(prepaidamount);
                                        ...
                                        else
                                        {
                                            ...
                                            Return_amount = parseInt(prepaidamount)- parseInt(totalAmount);
                                            $('#paidAmount').val(0);
