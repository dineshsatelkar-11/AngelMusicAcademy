                                    ...
                                    <div class="x_content">
                                        ...
                                        <form  method="get" action="../../PackageSave" id="demo-form2" onsubmit="return valid();" data-parsley-vdalidate class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="Fee" name="Fee" placeholder="Package Fee" required="required" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <td class="table_center"><a href="EditPackage.jsp?packageid=<%=p.getId()%>" role="button" data-toggle="modal" data-id="<%=j%>"><i id="<%=j%>" class="fa-2x glyphicon glyphicon-edit edit_prd1"></i></a></td>

                                            <%
                                                if (p.isStatus()) {
                                            %>
                                            <td class="table_center">Active </td>
                                            <form action="../../PackageAcive" method="post">
