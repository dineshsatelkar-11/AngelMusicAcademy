            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    <div class="">
                        ...
                        <div class="x_content">
                            <form action="../../OldStudentPayment" onsubmit="return valid()" class="form-horizontal form-label-left" novalidate method="get">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <center > <span id="followupdate" style="color:red">Select Due Date</span></center >
                                        <input type="text" id="datetimepicker1" required="" style="text-align: center"  name="duedate" placeholder="Select Due Date" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                                     
                                        <input type="text" id="datetimepicker2" required="" style="text-align: center"  name="paymentDate" placeholder="Payment Date" class="form-control">
                                    </div>
                                </div>
