                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                                    <select type="text" name="Category" id="Category" required="" class="form-control">
                                                                        <option value="<%=pd.getCategory().getId()%>"><%=pd.getCategory().getCategory()%></option>
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                                    <select type="text" name="Brand" id="Brand"  class="form-control">
                                                                        <option value="<%=pd.getBrand().getId()%>"><%=pd.getBrand().getBrand()%></option>
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                                    <select type="text" name="Model" id="Model"  class="form-control">
                                                                        <option value="<%=pd.getModel().getId()%>"><%=pd.getModel().getModelName()%></option>
                                                                ...
                                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                                    <select type="text" name="ColorName" id="ColorName"  class="form-control">
                                                                        <option value="<%=pd.getColorModel().getId()%>"><%=pd.getColorModel().getColorName()%></option>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4 col-sm-6 col-xs-12">
                                                                    <input type="text"  id="productquantity"  name="productquantity" required="required" value="<%=pd.getProductquantity()%>"  class="form-control priceup" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                                                                </div>
