...
<!--                                <div class="x_panel" style="">
                       ...
                       <%
                            BranchProduct p = new BranchProduct();
                            BranchProductDao b1 = new BranchProductDao();
                            List<BranchProduct> AllBrand1 = b1.getAllProduct();
                            int i = 0;
                            for (BranchProduct c1 : AllBrand1) {
                        ...
                        %>
                         <tr>
                                                        ...
                                                        <td><%=c1.getProduct().getProductname()%></td>
